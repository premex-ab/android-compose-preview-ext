...
public val Devices.MOBISECTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=MOBI-SECTV, code=SEI800MOBI, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MOBI-SECTV, code=SEI800MOBI,
