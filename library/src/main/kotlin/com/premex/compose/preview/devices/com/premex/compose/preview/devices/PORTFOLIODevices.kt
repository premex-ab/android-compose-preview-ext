...
public val Devices.PORTFOLIO: Any
  get() = object {
      /** DeviceSpec(manufacturer=PORTFOLIO, code=P9001, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PORTFOLIO, code=P9001, width=800,
