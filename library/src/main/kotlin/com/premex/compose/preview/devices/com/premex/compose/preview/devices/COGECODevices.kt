...
public val Devices.COGECO: Any
  get() = object {
      /** DeviceSpec(manufacturer=COGECO, code=uiw4020cog, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=COGECO, code=uiw4020cog,
