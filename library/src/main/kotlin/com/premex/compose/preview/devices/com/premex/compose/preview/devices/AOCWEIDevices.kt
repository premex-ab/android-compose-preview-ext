...
public val Devices.AOCWEI: Any
  get() = object {
      /** DeviceSpec(manufacturer=AOCWEI, code=X800_EEA, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AOCWEI, code=X800_EEA, width=1200,
      height=2000, dpi=240, isGoogleDevice=false).code */
      val X800_EEA = "spec:width=1200,height=2000,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=AOCWEI, code=X800_US, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AOCWEI, code=X800_US, width=1200,
      height=2000, dpi=240, isGoogleDevice=false).code */
