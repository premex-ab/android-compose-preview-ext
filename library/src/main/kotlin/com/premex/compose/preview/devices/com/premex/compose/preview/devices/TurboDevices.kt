...
public val Devices.Turbo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Turbo, code=Turbo_X8, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Turbo, code=Turbo_X8, width=720,
