...
public val Devices.Russound: Any
  get() = object {
      /** DeviceSpec(manufacturer=Russound, code=XTS7, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Russound, code=XTS7, width=800,
