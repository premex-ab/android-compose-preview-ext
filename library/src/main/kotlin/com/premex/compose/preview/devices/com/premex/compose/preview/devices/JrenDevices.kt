...
public val Devices.Jren: Any
  get() = object {
      /** DeviceSpec(manufacturer=jren, code=JR-J8, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=jren, code=JR-J8, width=800,
