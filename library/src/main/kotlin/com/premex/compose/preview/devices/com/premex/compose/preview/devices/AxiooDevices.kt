...
public val Devices.Axioo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Axioo, code=PICOpad_7H_R8, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Axioo, code=PICOpad_7H_R8,
