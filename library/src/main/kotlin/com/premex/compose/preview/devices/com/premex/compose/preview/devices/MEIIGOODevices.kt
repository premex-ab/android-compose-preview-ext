...
public val Devices.MEIIGOO: Any
  get() = object {
      /** DeviceSpec(manufacturer=MEIIGOO, code=MEIIGOO_S8, width=1080, height=2160, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MEIIGOO, code=MEIIGOO_S8,
