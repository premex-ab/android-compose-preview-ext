...
public val Devices.Gear: Any
  get() = object {
      /** DeviceSpec(manufacturer=gear, code=Feel_1008S, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=gear, code=Feel_1008S, width=800,
