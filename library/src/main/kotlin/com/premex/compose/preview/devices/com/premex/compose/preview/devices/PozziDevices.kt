...
public val Devices.Pozzi: Any
  get() = object {
      /** DeviceSpec(manufacturer=Pozzi, code=Pozzi_Neo_1, width=720, height=1600, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Pozzi, code=Pozzi_Neo_1, width=720,
