...
public val Devices.Telenet: Any
  get() = object {
      /** DeviceSpec(manufacturer=telenet, code=sti6160d332, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=telenet, code=sti6160d332,
