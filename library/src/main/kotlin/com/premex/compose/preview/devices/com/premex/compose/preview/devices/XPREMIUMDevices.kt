...
public val Devices.XPREMIUM: Any
  get() = object {
      /** DeviceSpec(manufacturer=X-PREMIUM, code=X1, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=X-PREMIUM, code=X1, width=800,
