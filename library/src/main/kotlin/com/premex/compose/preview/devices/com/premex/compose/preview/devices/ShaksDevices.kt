...
public val Devices.Shaks: Any
  get() = object {
      /** DeviceSpec(manufacturer=Shaks, code=TSA, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Shaks, code=TSA, width=1080,
