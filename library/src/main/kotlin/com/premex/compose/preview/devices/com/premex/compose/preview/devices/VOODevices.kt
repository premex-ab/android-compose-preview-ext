...
public val Devices.VOO: Any
  get() = object {
      /** DeviceSpec(manufacturer=VOO, code=DV8220, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VOO, code=DV8220, width=1080,
