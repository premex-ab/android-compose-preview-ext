...
public val Devices.TriaPlay: Any
  get() = object {
      /** DeviceSpec(manufacturer=TriaPlay, code=TriaPlayBox, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TriaPlay, code=TriaPlayBox,
