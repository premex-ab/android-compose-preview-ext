...
public val Devices.WISETECH: Any
  get() = object {
      /** DeviceSpec(manufacturer=WISE-TECH, code=P1_Plus, width=720, height=1520, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WISE-TECH, code=P1_Plus, width=720,
