...
public val Devices.Orinoquia: Any
  get() = object {
      /** DeviceSpec(manufacturer=Orinoquia, code=hws7701u, width=600, height=976, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Orinoquia, code=hws7701u,
      width=600, height=976, dpi=160, isGoogleDevice=false).code */
      val HWS7701U = "spec:width=600,height=976,unit=px,dpi=160"

      /** DeviceSpec(manufacturer=Orinoquia, code=hws7721u, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Orinoquia, code=hws7721u,
