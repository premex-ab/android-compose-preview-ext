...
public val Devices.UBOS: Any
  get() = object {
      /** DeviceSpec(manufacturer=UBOS, code=UTAB, width=1200, height=1920, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=UBOS, code=UTAB, width=1200,
