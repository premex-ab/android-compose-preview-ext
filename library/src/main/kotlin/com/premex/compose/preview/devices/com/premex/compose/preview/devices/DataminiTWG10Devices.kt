...
public val Devices.DataminiTWG10: Any
  get() = object {
      /** DeviceSpec(manufacturer=Datamini-TWG10, code=K508101, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Datamini-TWG10, code=K508101,
