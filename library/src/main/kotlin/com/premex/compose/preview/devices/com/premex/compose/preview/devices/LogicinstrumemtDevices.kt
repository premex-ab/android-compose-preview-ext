...
public val Devices.Logicinstrumemt: Any
  get() = object {
      /** DeviceSpec(manufacturer=logic_instrumemt, code=lifbn101, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=logic_instrumemt, code=lifbn101,
