...
public val Devices.Babal: Any
  get() = object {
      /** DeviceSpec(manufacturer=Babal, code=Babal_1008, width=720, height=1440, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Babal, code=Babal_1008, width=720,
