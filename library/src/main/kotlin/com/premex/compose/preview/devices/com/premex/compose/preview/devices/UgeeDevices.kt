...
public val Devices.Ugee: Any
  get() = object {
      /** DeviceSpec(manufacturer=ugee, code=Hera_Vis_WIFI, width=1600, height=2400, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ugee, code=Hera_Vis_WIFI,
      width=1600, height=2400, dpi=320, isGoogleDevice=false).code */
      val HERA_VIS_WIFI = "spec:width=1600,height=2400,unit=px,dpi=320"

      /** DeviceSpec(manufacturer=ugee, code=ugeeUT1Lite_EEA, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ugee, code=ugeeUT1Lite_EEA,
      width=1200, height=2000, dpi=240, isGoogleDevice=false).code */
      val UGEEUT1LITE_EEA = "spec:width=1200,height=2000,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=ugee, code=ugeeUT1Lite_NOEEA, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ugee, code=ugeeUT1Lite_NOEEA,
      width=1200, height=2000, dpi=240, isGoogleDevice=false).code */
