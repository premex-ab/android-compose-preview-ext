...
public val Devices.Avaya: Any
  get() = object {
      /** DeviceSpec(manufacturer=Avaya, code=K175, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Avaya, code=K175, width=800,
