...
public val Devices.ZIK: Any
  get() = object {
      /** DeviceSpec(manufacturer=ZIK, code=ZIK_W1027, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ZIK, code=ZIK_W1027, width=800,
