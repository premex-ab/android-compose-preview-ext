...
public val Devices.MyanmarNet: Any
  get() = object {
      /** DeviceSpec(manufacturer=MyanmarNet, code=SEI140FT, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MyanmarNet, code=SEI140FT,
