...
public val Devices.Ee: Any
  get() = object {
      /** DeviceSpec(manufacturer=ee, code=harrier_tab, width=1200, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ee, code=harrier_tab, width=1200,
