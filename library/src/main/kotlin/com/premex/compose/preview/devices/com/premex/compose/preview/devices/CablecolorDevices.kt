...
public val Devices.Cablecolor: Any
  get() = object {
      /** DeviceSpec(manufacturer=Cablecolor, code=GIU3A00, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Cablecolor, code=GIU3A00,
