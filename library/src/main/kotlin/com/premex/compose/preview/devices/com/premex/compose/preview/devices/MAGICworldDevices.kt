...
public val Devices.MAGICworld: Any
  get() = object {
      /** DeviceSpec(manufacturer=MAGICworld, code=longshan, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MAGICworld, code=longshan,
