...
public val Devices.TAMBOARD: Any
  get() = object {
      /** DeviceSpec(manufacturer=TAMBOARD, code=TB_GH, width=2160, height=3840, dpi=420,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TAMBOARD, code=TB_GH, width=2160,
