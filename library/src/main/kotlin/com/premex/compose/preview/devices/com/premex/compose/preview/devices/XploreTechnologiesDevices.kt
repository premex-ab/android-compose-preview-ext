...
public val Devices.XploreTechnologies: Any
  get() = object {
      /** DeviceSpec(manufacturer=Xplore_Technologies, code=XSLATE_D10, width=768, height=1366,
      dpi=160, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Xplore_Technologies,
      code=XSLATE_D10, width=768, height=1366, dpi=160, isGoogleDevice=false).code */
