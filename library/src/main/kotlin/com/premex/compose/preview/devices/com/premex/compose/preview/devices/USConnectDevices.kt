...
public val Devices.USConnect: Any
  get() = object {
      /** DeviceSpec(manufacturer=USConnect, code=VT10M2, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=USConnect, code=VT10M2, width=800,
