...
public val Devices.TAGDC: Any
  get() = object {
      /** DeviceSpec(manufacturer=TAG-DC, code=TAG-DC, width=1200, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TAG-DC, code=TAG-DC, width=1200,
