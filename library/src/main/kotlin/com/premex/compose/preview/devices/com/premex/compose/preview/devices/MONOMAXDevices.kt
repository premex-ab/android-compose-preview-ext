...
public val Devices.MONOMAX: Any
  get() = object {
      /** DeviceSpec(manufacturer=MONOMAX, code=DV6071Z-KTM, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MONOMAX, code=DV6071Z-KTM,
