...
public val Devices.Telecable: Any
  get() = object {
      /** DeviceSpec(manufacturer=Telecable, code=dtiw384, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Telecable, code=dtiw384,
