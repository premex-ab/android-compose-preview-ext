...
public val Devices.Mobily: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mobily, code=qnbml, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mobily, code=qnbml, width=720,
