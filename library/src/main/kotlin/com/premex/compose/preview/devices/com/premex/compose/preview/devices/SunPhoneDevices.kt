...
public val Devices.SunPhone: Any
  get() = object {
      /** DeviceSpec(manufacturer=SunPhone, code=L4, width=720, height=1600, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SunPhone, code=L4, width=720,
