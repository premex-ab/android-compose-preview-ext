...
public val Devices.Equator: Any
  get() = object {
      /** DeviceSpec(manufacturer=Equator, code=Axis, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Equator, code=Axis, width=720,
