...
public val Devices.Xelex: Any
  get() = object {
      /** DeviceSpec(manufacturer=Xelex, code=Gama_Tab_X8, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Xelex, code=Gama_Tab_X8, width=800,
