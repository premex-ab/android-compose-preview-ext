...
public val Devices.Estla: Any
  get() = object {
      /** DeviceSpec(manufacturer=Estla, code=sindorim, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Estla, code=sindorim, width=1080,
