...
public val Devices.Sencor: Any
  get() = object {
      /** DeviceSpec(manufacturer=sencor, code=10_1Q205, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=sencor, code=10_1Q205, width=800,
