...
public val Devices.YotaPhone: Any
  get() = object {
      /** DeviceSpec(manufacturer=YotaPhone, code=yotaphone2, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YotaPhone, code=yotaphone2,
