...
public val Devices.WeTek: Any
  get() = object {
      /** DeviceSpec(manufacturer=WeTek, code=wh220, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WeTek, code=wh220, width=1080,
