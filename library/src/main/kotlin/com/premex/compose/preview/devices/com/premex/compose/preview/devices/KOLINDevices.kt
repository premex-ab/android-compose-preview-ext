...
public val Devices.KOLIN: Any
  get() = object {
      /** DeviceSpec(manufacturer=KOLIN, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=KOLIN, code=hongkong, width=1080,
