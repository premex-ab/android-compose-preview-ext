...
public val Devices.LiteTEL: Any
  get() = object {
      /** DeviceSpec(manufacturer=LiteTEL, code=X20, width=480, height=960, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LiteTEL, code=X20, width=480,
