...
public val Devices.AVA: Any
  get() = object {
      /** DeviceSpec(manufacturer=AVA, code=AVA-RM-RX1, width=480, height=1170, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AVA, code=AVA-RM-RX1, width=480,
      height=1170, dpi=240, isGoogleDevice=false).code */
      val AVA_RM_RX1 = "spec:width=480,height=1170,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=AVA, code=AVA-RM-RX2-US, width=540, height=1080, dpi=260,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AVA, code=AVA-RM-RX2-US, width=540,
