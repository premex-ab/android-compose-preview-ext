...
public val Devices.OKV: Any
  get() = object {
      /** DeviceSpec(manufacturer=OKV, code=rk3588_t, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=OKV, code=rk3588_t, width=2160,
