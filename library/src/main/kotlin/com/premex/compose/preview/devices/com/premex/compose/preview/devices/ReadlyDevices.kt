...
public val Devices.Readly: Any
  get() = object {
      /** DeviceSpec(manufacturer=Readly, code=ReadlyReaderOne, width=800, height=1280, dpi=200,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Readly, code=ReadlyReaderOne,
