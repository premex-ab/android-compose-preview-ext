...
public val Devices.MintMobile: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mint_Mobile, code=Emerald, width=480, height=854, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mint_Mobile, code=Emerald,
