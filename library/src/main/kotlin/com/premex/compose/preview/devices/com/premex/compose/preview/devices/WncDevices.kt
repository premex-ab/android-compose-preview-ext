...
public val Devices.Wnc: Any
  get() = object {
      /** DeviceSpec(manufacturer=wnc, code=JS8V, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=wnc, code=JS8V, width=1080,
