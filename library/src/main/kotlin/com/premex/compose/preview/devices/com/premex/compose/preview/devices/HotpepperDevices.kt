...
public val Devices.Hotpepper: Any
  get() = object {
      /** DeviceSpec(manufacturer=Hotpepper, code=HPPL67A, width=720, height=1612, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Hotpepper, code=HPPL67A, width=720,
