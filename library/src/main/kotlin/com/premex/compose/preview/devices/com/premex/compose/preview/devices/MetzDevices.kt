...
public val Devices.Metz: Any
  get() = object {
      /** DeviceSpec(manufacturer=Metz, code=shinagawa, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Metz, code=shinagawa, width=720,
