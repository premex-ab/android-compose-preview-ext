...
public val Devices.TIME2: Any
  get() = object {
      /** DeviceSpec(manufacturer=TIME2, code=TP1060J, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TIME2, code=TP1060J, width=800,
