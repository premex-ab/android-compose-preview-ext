...
public val Devices.ATILIMmPAD: Any
  get() = object {
      /** DeviceSpec(manufacturer=ATILIM_mPAD, code=ATILIM_mPAD07, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ATILIM_mPAD, code=ATILIM_mPAD07,
