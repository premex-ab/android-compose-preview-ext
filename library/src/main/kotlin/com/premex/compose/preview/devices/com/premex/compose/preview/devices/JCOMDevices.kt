...
public val Devices.JCOM: Any
  get() = object {
      /** DeviceSpec(manufacturer=J-COM, code=SC40, width=480, height=800, dpi=220,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=J-COM, code=SC40, width=480,
