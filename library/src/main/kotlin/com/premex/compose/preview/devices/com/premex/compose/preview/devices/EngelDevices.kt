...
public val Devices.Engel: Any
  get() = object {
      /** DeviceSpec(manufacturer=Engel, code=bangbae, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Engel, code=bangbae, width=1080,
