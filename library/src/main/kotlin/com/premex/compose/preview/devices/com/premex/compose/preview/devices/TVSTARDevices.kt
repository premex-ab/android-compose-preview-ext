...
public val Devices.TVSTAR: Any
  get() = object {
      /** DeviceSpec(manufacturer=TVSTAR, code=seocho, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TVSTAR, code=seocho, width=1080,
