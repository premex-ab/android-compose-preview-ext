...
public val Devices.GOODEE: Any
  get() = object {
      /** DeviceSpec(manufacturer=GOODEE, code=himalaya, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GOODEE, code=himalaya, width=1080,
