...
public val Devices.NIKAIPRO: Any
  get() = object {
      /** DeviceSpec(manufacturer=NIKAI-PRO, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NIKAI-PRO, code=hongkong,
