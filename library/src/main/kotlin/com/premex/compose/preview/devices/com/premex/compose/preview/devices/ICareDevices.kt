...
public val Devices.ICare: Any
  get() = object {
      /** DeviceSpec(manufacturer=iCare, code=iCare10, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=iCare, code=iCare10, width=1200,
