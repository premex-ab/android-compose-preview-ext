...
public val Devices.ACTECK: Any
  get() = object {
      /** DeviceSpec(manufacturer=ACTECK, code=AC_934312, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ACTECK, code=AC_934312, width=600,
