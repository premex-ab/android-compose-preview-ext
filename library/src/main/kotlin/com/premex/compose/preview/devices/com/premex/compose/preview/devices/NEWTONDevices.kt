...
public val Devices.NEWTON: Any
  get() = object {
      /** DeviceSpec(manufacturer=NEWTON, code=H1, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NEWTON, code=H1, width=800,
