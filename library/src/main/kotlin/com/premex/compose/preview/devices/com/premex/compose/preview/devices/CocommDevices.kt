...
public val Devices.Cocomm: Any
  get() = object {
      /** DeviceSpec(manufacturer=cocomm, code=F780, width=480, height=854, dpi=200,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=cocomm, code=F780, width=480,
