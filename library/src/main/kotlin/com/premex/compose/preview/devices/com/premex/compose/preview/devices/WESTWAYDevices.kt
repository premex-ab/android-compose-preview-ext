...
public val Devices.WESTWAY: Any
  get() = object {
      /** DeviceSpec(manufacturer=WESTWAY, code=mountbaker, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WESTWAY, code=mountbaker,
