...
public val Devices.HannSpree: Any
  get() = object {
      /** DeviceSpec(manufacturer=HannSpree, code=HSG1376_MT8163, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HannSpree, code=HSG1376_MT8163,
