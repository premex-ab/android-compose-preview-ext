...
public val Devices.Joystar: Any
  get() = object {
      /** DeviceSpec(manufacturer=Joystar, code=J6, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Joystar, code=J6, width=800,
