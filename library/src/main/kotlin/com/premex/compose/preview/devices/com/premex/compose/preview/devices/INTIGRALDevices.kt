...
public val Devices.INTIGRAL: Any
  get() = object {
      /** DeviceSpec(manufacturer=INTIGRAL, code=HP40A, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=INTIGRAL, code=HP40A, width=1080,
