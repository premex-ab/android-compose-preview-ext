...
public val Devices.ViettelTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=ViettelTV, code=HP40A, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ViettelTV, code=HP40A, width=1080,
