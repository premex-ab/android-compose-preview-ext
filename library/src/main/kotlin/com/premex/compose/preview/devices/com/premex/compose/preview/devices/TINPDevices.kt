...
public val Devices.TINP: Any
  get() = object {
      /** DeviceSpec(manufacturer=TINP, code=DV8219, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TINP, code=DV8219, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
      val DV8219 = "spec:width=1080,height=1920,unit=px,dpi=320"

      /** DeviceSpec(manufacturer=TINP, code=DV8330-C, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TINP, code=DV8330-C, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
