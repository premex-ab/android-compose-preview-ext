...
public val Devices.RLG: Any
  get() = object {
      /** DeviceSpec(manufacturer=RLG, code=Eagle-2024, width=800, height=1280, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RLG, code=Eagle-2024, width=800,
