...
public val Devices.UNISCOPE: Any
  get() = object {
      /** DeviceSpec(manufacturer=UNISCOPE, code=s6w, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=UNISCOPE, code=s6w, width=800,
