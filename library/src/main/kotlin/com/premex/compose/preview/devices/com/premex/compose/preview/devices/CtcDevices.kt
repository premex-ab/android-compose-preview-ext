...
public val Devices.Ctc: Any
  get() = object {
      /** DeviceSpec(manufacturer=ctc, code=sti6130d353, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ctc, code=sti6130d353, width=1080,
