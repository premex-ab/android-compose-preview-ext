...
public val Devices.Bigme: Any
  get() = object {
      /** DeviceSpec(manufacturer=Bigme, code=Smartphone, width=824, height=1648, dpi=300,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Bigme, code=Smartphone, width=824,
      height=1648, dpi=300, isGoogleDevice=false).code */
