...
public val Devices.VISUALLAND: Any
  get() = object {
      /** DeviceSpec(manufacturer=VISUAL-LAND, code=Elite10QH, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VISUAL-LAND, code=Elite10QH,
      width=800, height=1280, dpi=213, isGoogleDevice=false).code */
      val ELITE10QH = "spec:width=800,height=1280,unit=px,dpi=213"

      /** DeviceSpec(manufacturer=VISUAL-LAND, code=Elite10QHPro, width=800, height=1280, dpi=200,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VISUAL-LAND, code=Elite10QHPro,
