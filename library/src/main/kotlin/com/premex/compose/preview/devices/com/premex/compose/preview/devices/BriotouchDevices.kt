...
public val Devices.Briotouch: Any
  get() = object {
      /** DeviceSpec(manufacturer=Briotouch, code=ULTRA-PLUS-BR, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Briotouch, code=ULTRA-PLUS-BR,
