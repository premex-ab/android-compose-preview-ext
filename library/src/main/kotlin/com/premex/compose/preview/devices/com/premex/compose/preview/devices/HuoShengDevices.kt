...
public val Devices.HuoSheng: Any
  get() = object {
      /** DeviceSpec(manufacturer=HuoSheng, code=HMS-PD-X1C-3, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HuoSheng, code=HMS-PD-X1C-3,
