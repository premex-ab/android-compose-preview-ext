...
public val Devices.Mirarel: Any
  get() = object {
      /** DeviceSpec(manufacturer=mirarel, code=ksr, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=mirarel, code=ksr, width=1080,
