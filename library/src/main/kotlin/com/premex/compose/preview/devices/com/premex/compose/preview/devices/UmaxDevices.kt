...
public val Devices.Umax: Any
  get() = object {
      /** DeviceSpec(manufacturer=Umax, code=8Qa_3G, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Umax, code=8Qa_3G, width=800,
