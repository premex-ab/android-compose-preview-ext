...
public val Devices.ECHOLINK: Any
  get() = object {
      /** DeviceSpec(manufacturer=ECHOLINK, code=IAD, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ECHOLINK, code=IAD, width=720,
