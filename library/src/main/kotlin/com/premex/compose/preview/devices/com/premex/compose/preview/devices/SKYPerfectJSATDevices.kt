...
public val Devices.SKYPerfectJSAT: Any
  get() = object {
      /** DeviceSpec(manufacturer=SKYPerfectJSAT, code=SKP-IS401, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SKYPerfectJSAT, code=SKP-IS401,
