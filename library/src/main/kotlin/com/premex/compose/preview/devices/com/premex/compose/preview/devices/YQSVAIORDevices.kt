...
public val Devices.YQSVAIOR: Any
  get() = object {
      /** DeviceSpec(manufacturer=YQSVAIOR, code=YQ10, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YQSVAIOR, code=YQ10, width=800,
