...
public val Devices.TBC: Any
  get() = object {
      /** DeviceSpec(manufacturer=TBC, code=TATV_8000, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TBC, code=TATV_8000, width=1080,
