...
public val Devices.LGCNS: Any
  get() = object {
      /** DeviceSpec(manufacturer=LG_CNS, code=LPT_200AR, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LG_CNS, code=LPT_200AR, width=800,
