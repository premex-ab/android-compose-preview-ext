...
public val Devices.NETOGY: Any
  get() = object {
      /** DeviceSpec(manufacturer=NETOGY, code=YXU, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NETOGY, code=YXU, width=1080,
