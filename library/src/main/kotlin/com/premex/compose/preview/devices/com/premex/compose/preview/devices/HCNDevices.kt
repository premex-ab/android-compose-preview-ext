...
public val Devices.HCN: Any
  get() = object {
      /** DeviceSpec(manufacturer=HCN, code=IMT-H6300, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HCN, code=IMT-H6300, width=720,
