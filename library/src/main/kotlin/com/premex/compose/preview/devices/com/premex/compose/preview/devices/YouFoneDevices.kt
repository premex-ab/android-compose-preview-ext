...
public val Devices.YouFone: Any
  get() = object {
      /** DeviceSpec(manufacturer=YouFone, code=Amigo7xYUF, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YouFone, code=Amigo7xYUF,
