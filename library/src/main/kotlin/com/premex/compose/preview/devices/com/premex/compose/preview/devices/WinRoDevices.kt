...
public val Devices.WinRo: Any
  get() = object {
      /** DeviceSpec(manufacturer=WinRo, code=Voni10, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WinRo, code=Voni10, width=800,
