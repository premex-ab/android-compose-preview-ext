...
public val Devices.SinoGNSS: Any
  get() = object {
      /** DeviceSpec(manufacturer=SinoGNSS, code=R60, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SinoGNSS, code=R60, width=1080,
