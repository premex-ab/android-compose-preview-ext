...
public val Devices.AVH: Any
  get() = object {
      /** DeviceSpec(manufacturer=AVH, code=Excer_10_PRO, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AVH, code=Excer_10_PRO, width=800,
