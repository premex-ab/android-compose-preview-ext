...
public val Devices.MozaTab: Any
  get() = object {
      /** DeviceSpec(manufacturer=mozaTab, code=MTN_E1, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=mozaTab, code=MTN_E1, width=800,
