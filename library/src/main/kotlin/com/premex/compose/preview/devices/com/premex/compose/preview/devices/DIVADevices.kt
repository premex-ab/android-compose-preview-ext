...
public val Devices.DIVA: Any
  get() = object {
      /** DeviceSpec(manufacturer=DIVA, code=T10K_Plus, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DIVA, code=T10K_Plus, width=800,
      height=1280, dpi=213, isGoogleDevice=false).code */
      val T10K_PLUS = "spec:width=800,height=1280,unit=px,dpi=213"

      /** DeviceSpec(manufacturer=DIVA, code=T7K_PLUS_SE3_EEA, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DIVA, code=T7K_PLUS_SE3_EEA,
