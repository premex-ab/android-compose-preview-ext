...
public val Devices.POWEROLOGY: Any
  get() = object {
      /** DeviceSpec(manufacturer=POWEROLOGY, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=POWEROLOGY, code=hongkong,
