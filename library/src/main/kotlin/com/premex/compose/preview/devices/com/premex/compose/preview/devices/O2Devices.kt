...
public val Devices.O2: Any
  get() = object {
      /** DeviceSpec(manufacturer=O2, code=O2TV_B866V2, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=O2, code=O2TV_B866V2, width=1080,
