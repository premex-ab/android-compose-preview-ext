...
public val Devices.Veidoo: Any
  get() = object {
      /** DeviceSpec(manufacturer=veidoo, code=T30_Plus_EEA, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=veidoo, code=T30_Plus_EEA,
      width=800, height=1280, dpi=213, isGoogleDevice=false).code */
      val T30_PLUS_EEA = "spec:width=800,height=1280,unit=px,dpi=213"

      /** DeviceSpec(manufacturer=veidoo, code=T80_PLUS, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=veidoo, code=T80_PLUS, width=800,
