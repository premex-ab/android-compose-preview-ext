...
public val Devices.MIKU: Any
  get() = object {
      /** DeviceSpec(manufacturer=MIKU, code=TAB63A, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MIKU, code=TAB63A, width=1200,
