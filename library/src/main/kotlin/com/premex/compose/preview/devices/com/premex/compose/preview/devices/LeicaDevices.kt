...
public val Devices.Leica: Any
  get() = object {
      /** DeviceSpec(manufacturer=Leica, code=CSX8, width=1200, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Leica, code=CSX8, width=1200,
