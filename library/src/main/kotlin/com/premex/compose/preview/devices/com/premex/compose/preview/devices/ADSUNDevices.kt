...
public val Devices.ADSUN: Any
  get() = object {
      /** DeviceSpec(manufacturer=ADSUN, code=stanford, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ADSUN, code=stanford, width=720,
