...
public val Devices.Menfop: Any
  get() = object {
      /** DeviceSpec(manufacturer=menfop, code=HaierP8B, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=menfop, code=HaierP8B, width=800,
