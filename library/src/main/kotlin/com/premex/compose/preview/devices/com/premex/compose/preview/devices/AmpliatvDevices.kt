...
public val Devices.Ampliatv: Any
  get() = object {
      /** DeviceSpec(manufacturer=ampliatv, code=sti6160d327, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ampliatv, code=sti6160d327,
