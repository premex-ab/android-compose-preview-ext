...
public val Devices.Synetech: Any
  get() = object {
      /** DeviceSpec(manufacturer=Synetech, code=rk3588_t, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Synetech, code=rk3588_t,
