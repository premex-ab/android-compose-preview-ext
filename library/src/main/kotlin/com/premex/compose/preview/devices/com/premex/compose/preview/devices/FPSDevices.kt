...
public val Devices.FPS: Any
  get() = object {
      /** DeviceSpec(manufacturer=FPS, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FPS, code=hongkong, width=1080,
