...
public val Devices.GPELECTRONIC: Any
  get() = object {
      /** DeviceSpec(manufacturer=GPELECTRONIC, code=YC-83P, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GPELECTRONIC, code=YC-83P,
      width=800, height=1280, dpi=213, isGoogleDevice=false).code */
      val YC_83P = "spec:width=800,height=1280,unit=px,dpi=213"

      /** DeviceSpec(manufacturer=GPELECTRONIC, code=YC-83T, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GPELECTRONIC, code=YC-83T,
