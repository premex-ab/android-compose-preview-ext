...
public val Devices.Logik: Any
  get() = object {
      /** DeviceSpec(manufacturer=Logik, code=ueno, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Logik, code=ueno, width=720,
