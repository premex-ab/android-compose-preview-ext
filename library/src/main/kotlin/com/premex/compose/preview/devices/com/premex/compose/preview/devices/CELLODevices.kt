...
public val Devices.CELLO: Any
  get() = object {
      /** DeviceSpec(manufacturer=CELLO, code=ueno, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CELLO, code=ueno, width=720,
