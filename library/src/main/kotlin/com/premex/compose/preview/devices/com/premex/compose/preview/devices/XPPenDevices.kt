...
public val Devices.XPPen: Any
  get() = object {
      /** DeviceSpec(manufacturer=XPPen, code=Titan_XPPen, width=1440, height=2160, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=XPPen, code=Titan_XPPen,
