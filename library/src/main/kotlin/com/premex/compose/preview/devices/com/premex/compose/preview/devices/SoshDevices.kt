...
public val Devices.Sosh: Any
  get() = object {
      /** DeviceSpec(manufacturer=Sosh, code=SoshPhone, width=480, height=960, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Sosh, code=SoshPhone, width=480,
