...
public val Devices.CONVERGE: Any
  get() = object {
      /** DeviceSpec(manufacturer=CONVERGE, code=T7045PS, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CONVERGE, code=T7045PS, width=600,
