...
public val Devices.IQUAL: Any
  get() = object {
      /** DeviceSpec(manufacturer=IQUAL, code=T10W2, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=IQUAL, code=T10W2, width=800,
