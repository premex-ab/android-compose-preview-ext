...
public val Devices.Iriver: Any
  get() = object {
      /** DeviceSpec(manufacturer=Iriver, code=seocho, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Iriver, code=seocho, width=1080,
