...
public val Devices.STC: Any
  get() = object {
      /** DeviceSpec(manufacturer=STC, code=SEI560STC, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=STC, code=SEI560STC, width=1080,
