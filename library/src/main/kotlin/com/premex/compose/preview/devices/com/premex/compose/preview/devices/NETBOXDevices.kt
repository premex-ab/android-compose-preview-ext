...
public val Devices.NETBOX: Any
  get() = object {
      /** DeviceSpec(manufacturer=NETBOX, code=uiw4030dnm, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NETBOX, code=uiw4030dnm,
