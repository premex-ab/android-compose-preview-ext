...
public val Devices.OPEL: Any
  get() = object {
      /** DeviceSpec(manufacturer=OPEL, code=SMARTJ5-M, width=540, height=960, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=OPEL, code=SMARTJ5-M, width=540,
      height=960, dpi=240, isGoogleDevice=false).code */
      val SMARTJ5_M = "spec:width=540,height=960,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=OPEL, code=SMARTKIDS, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=OPEL, code=SMARTKIDS, width=720,
