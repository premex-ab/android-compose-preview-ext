...
public val Devices.Mosambee: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mosambee, code=Qphone2_4110, width=480, height=960, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mosambee, code=Qphone2_4110,
