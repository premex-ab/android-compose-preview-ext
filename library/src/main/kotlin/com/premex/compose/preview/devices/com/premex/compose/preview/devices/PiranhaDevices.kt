...
public val Devices.Piranha: Any
  get() = object {
      /** DeviceSpec(manufacturer=Piranha, code=Piranha8032, width=1080, height=2220, dpi=440,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Piranha, code=Piranha8032,
