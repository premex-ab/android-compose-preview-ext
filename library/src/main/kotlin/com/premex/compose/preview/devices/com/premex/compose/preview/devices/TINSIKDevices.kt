...
public val Devices.TINSIK: Any
  get() = object {
      /** DeviceSpec(manufacturer=TINSIK, code=A19_Plus, width=540, height=1200, dpi=200,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TINSIK, code=A19_Plus, width=540,
