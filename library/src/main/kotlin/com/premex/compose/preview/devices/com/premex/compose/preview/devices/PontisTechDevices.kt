...
public val Devices.PontisTech: Any
  get() = object {
      /** DeviceSpec(manufacturer=PontisTech, code=SEI700PTS, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PontisTech, code=SEI700PTS,
