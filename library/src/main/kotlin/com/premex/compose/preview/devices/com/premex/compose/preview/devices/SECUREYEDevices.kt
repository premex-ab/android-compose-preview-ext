...
public val Devices.SECUREYE: Any
  get() = object {
      /** DeviceSpec(manufacturer=SECUREYE, code=S-SAB220, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SECUREYE, code=S-SAB220, width=600,
