...
public val Devices.JCB: Any
  get() = object {
      /** DeviceSpec(manufacturer=JCB, code=JCB_TP231, width=720, height=1520, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=JCB, code=JCB_TP231, width=720,
