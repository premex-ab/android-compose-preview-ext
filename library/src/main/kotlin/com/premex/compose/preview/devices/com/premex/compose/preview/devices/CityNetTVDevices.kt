...
public val Devices.CityNetTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=CityNetTV, code=SEI900BUQC, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CityNetTV, code=SEI900BUQC,
