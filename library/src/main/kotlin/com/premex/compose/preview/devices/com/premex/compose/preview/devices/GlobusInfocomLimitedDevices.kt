...
public val Devices.GlobusInfocomLimited: Any
  get() = object {
      /** DeviceSpec(manufacturer=Globus-Infocom-Limited, code=MTK9679, width=2160, height=3840,
      dpi=480, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Globus-Infocom-Limited,
      code=MTK9679, width=2160, height=3840, dpi=480, isGoogleDevice=false).code */
