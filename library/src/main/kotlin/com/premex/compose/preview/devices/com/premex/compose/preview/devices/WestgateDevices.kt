...
public val Devices.Westgate: Any
  get() = object {
      /** DeviceSpec(manufacturer=Westgate, code=Westgate-T801, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Westgate, code=Westgate-T801,
