...
public val Devices.REEDER: Any
  get() = object {
      /** DeviceSpec(manufacturer=REEDER, code=M7Go_2019, width=600, height=1024, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=REEDER, code=M7Go_2019, width=600,
