...
public val Devices.YARA: Any
  get() = object {
      /** DeviceSpec(manufacturer=YARA, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YARA, code=hongkong, width=1080,
