...
public val Devices.Movistar: Any
  get() = object {
      /** DeviceSpec(manufacturer=Movistar, code=hwt101, width=752, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Movistar, code=hwt101, width=752,
