...
public val Devices.YOUIN: Any
  get() = object {
      /** DeviceSpec(manufacturer=YOUIN, code=HND, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YOUIN, code=HND, width=1080,
