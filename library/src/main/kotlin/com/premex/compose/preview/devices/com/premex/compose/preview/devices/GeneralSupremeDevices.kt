...
public val Devices.GeneralSupreme: Any
  get() = object {
      /** DeviceSpec(manufacturer=GeneralSupreme, code=longshan, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GeneralSupreme, code=longshan,
