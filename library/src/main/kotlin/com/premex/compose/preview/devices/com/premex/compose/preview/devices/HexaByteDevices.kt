...
public val Devices.HexaByte: Any
  get() = object {
      /** DeviceSpec(manufacturer=HexaByte, code=HB_X7, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HexaByte, code=HB_X7, width=600,
