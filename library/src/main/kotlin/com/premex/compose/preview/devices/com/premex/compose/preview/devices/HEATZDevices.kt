...
public val Devices.HEATZ: Any
  get() = object {
      /** DeviceSpec(manufacturer=HEATZ, code=Z9910A, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HEATZ, code=Z9910A, width=800,
