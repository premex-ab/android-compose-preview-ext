...
public val Devices.It: Any
  get() = object {
      /** DeviceSpec(manufacturer=it, code=IT_1101S, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=it, code=IT_1101S, width=800,
