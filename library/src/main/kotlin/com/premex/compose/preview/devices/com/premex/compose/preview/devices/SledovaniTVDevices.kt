...
public val Devices.SledovaniTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=SledovaniTV, code=DV8220, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SledovaniTV, code=DV8220,
