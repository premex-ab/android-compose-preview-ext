...
public val Devices.CIK: Any
  get() = object {
      /** DeviceSpec(manufacturer=CIK, code=S4000, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CIK, code=S4000, width=1080,
