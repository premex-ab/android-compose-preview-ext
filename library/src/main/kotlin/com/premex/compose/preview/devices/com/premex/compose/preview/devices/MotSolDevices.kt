...
public val Devices.MotSol: Any
  get() = object {
      /** DeviceSpec(manufacturer=MotSol, code=mkz_sdm660_64, width=480, height=800, dpi=220,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MotSol, code=mkz_sdm660_64,
      width=480, height=800, dpi=220, isGoogleDevice=false).code */
