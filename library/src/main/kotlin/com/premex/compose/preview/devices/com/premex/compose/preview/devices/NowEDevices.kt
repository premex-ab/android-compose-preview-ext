...
public val Devices.NowE: Any
  get() = object {
      /** DeviceSpec(manufacturer=Now_E, code=hk101, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Now_E, code=hk101, width=1080,
