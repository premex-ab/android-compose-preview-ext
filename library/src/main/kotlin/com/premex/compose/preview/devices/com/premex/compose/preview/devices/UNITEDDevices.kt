...
public val Devices.UNITED: Any
  get() = object {
      /** DeviceSpec(manufacturer=UNITED, code=gangbyeon, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=UNITED, code=gangbyeon, width=1080,
