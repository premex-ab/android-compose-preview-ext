...
public val Devices.MinimalPhone: Any
  get() = object {
      /** DeviceSpec(manufacturer=Minimal_Phone, code=MP01, width=600, height=800, dpi=180,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Minimal_Phone, code=MP01,
      width=600, height=800, dpi=180, isGoogleDevice=false).code */
