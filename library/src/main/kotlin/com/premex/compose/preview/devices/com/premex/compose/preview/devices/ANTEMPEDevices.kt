...
public val Devices.ANTEMPE: Any
  get() = object {
      /** DeviceSpec(manufacturer=ANTEMPE, code=D115_EEA, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ANTEMPE, code=D115_EEA, width=800,
