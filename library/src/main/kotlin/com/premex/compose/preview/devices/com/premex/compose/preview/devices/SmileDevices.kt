...
public val Devices.Smile: Any
  get() = object {
      /** DeviceSpec(manufacturer=Smile, code=A955Z, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Smile, code=A955Z, width=720,
