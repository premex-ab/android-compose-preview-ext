...
public val Devices.HIHI: Any
  get() = object {
      /** DeviceSpec(manufacturer=HIHI, code=HIHI-50KH-TAB-01-EEA, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HIHI, code=HIHI-50KH-TAB-01-EEA,
