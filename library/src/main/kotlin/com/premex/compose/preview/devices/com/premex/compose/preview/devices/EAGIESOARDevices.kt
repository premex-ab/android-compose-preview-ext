...
public val Devices.EAGIESOAR: Any
  get() = object {
      /** DeviceSpec(manufacturer=EAGIESOAR, code=EE1010_EEA, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=EAGIESOAR, code=EE1010_EEA,
