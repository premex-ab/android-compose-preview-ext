...
public val Devices.Ge: Any
  get() = object {
      /** DeviceSpec(manufacturer=ge, code=syklone, width=1080, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ge, code=syklone, width=1080,
