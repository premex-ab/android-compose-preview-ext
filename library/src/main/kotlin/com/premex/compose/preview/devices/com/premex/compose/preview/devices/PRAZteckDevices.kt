...
public val Devices.PRAZteck: Any
  get() = object {
      /** DeviceSpec(manufacturer=PRAZteck, code=PT7EduPad, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PRAZteck, code=PT7EduPad,
