...
public val Devices.Estelle: Any
  get() = object {
      /** DeviceSpec(manufacturer=Estelle, code=EST_001_BLK, width=1080, height=2160, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Estelle, code=EST_001_BLK,
