...
public val Devices.ISCED: Any
  get() = object {
      /** DeviceSpec(manufacturer=ISCED, code=ISCEDTAB21, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ISCED, code=ISCEDTAB21, width=800,
