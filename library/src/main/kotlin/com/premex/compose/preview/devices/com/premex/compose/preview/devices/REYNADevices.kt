...
public val Devices.REYNA: Any
  get() = object {
      /** DeviceSpec(manufacturer=REYNA, code=mountbaker, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=REYNA, code=mountbaker, width=720,
