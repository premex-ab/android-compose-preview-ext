...
public val Devices.Ktouch: Any
  get() = object {
      /** DeviceSpec(manufacturer=K-touch, code=Pace_2_Lite, width=800, height=1280, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=K-touch, code=Pace_2_Lite,
