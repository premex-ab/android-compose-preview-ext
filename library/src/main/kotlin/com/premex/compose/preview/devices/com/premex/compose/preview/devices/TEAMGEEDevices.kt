...
public val Devices.TEAMGEE: Any
  get() = object {
      /** DeviceSpec(manufacturer=TEAMGEE, code=G2, width=1080, height=1920, dpi=216,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TEAMGEE, code=G2, width=1080,
