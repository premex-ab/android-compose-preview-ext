...
public val Devices.Pantech: Any
  get() = object {
      /** DeviceSpec(manufacturer=Pantech, code=HS8929QC, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Pantech, code=HS8929QC, width=720,
