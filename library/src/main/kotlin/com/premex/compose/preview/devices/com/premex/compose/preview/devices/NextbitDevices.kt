...
public val Devices.Nextbit: Any
  get() = object {
      /** DeviceSpec(manufacturer=Nextbit, code=ether, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Nextbit, code=ether, width=1080,
