...
public val Devices.Teeview: Any
  get() = object {
      /** DeviceSpec(manufacturer=Teeview, code=lakeside, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Teeview, code=lakeside, width=1080,
