...
public val Devices.VSP: Any
  get() = object {
      /** DeviceSpec(manufacturer=VSP, code=beaudry, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VSP, code=beaudry, width=720,
