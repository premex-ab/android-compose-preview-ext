...
public val Devices.SAELITE: Any
  get() = object {
      /** DeviceSpec(manufacturer=SAELITE, code=MD1063B, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SAELITE, code=MD1063B, width=800,
