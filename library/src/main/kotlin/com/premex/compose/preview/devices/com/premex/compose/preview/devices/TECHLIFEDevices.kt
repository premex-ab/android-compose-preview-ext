...
public val Devices.TECHLIFE: Any
  get() = object {
      /** DeviceSpec(manufacturer=TECHLIFE, code=redwood, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TECHLIFE, code=redwood, width=720,
