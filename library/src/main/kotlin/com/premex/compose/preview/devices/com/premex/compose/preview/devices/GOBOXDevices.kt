 ...
 * ```
 */
public val Devices.GOBOX: Any
  get() = object {
      /** DeviceSpec(manufacturer=GOBOX, code=T2, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GOBOX, code=T2, width=600,
