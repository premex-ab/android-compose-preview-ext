...
public val Devices.Shuttle: Any
  get() = object {
      /** DeviceSpec(manufacturer=Shuttle, code=PNT-7045, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Shuttle, code=PNT-7045, width=600,
