...
public val Devices.PAITANRY: Any
  get() = object {
      /** DeviceSpec(manufacturer=PAITANRY, code=R16, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PAITANRY, code=R16, width=800,
