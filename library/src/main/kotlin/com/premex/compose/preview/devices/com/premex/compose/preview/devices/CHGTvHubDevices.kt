...
public val Devices.CHGTvHub: Any
  get() = object {
      /** DeviceSpec(manufacturer=CHG_Tv_Hub, code=uzx8020chm, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CHG_Tv_Hub, code=uzx8020chm,
