...
public val Devices.Mgears: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mgears, code=Mstick4-EEA, width=800, height=1280, dpi=230,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mgears, code=Mstick4-EEA,
      width=800, height=1280, dpi=230, isGoogleDevice=false).code */
