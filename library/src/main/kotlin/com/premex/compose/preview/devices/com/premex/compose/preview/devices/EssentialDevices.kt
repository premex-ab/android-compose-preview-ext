...
public val Devices.Essential: Any
  get() = object {
      /** DeviceSpec(manufacturer=essential, code=mata, width=1316, height=2560, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=essential, code=mata, width=1316,
