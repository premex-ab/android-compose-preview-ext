...
public val Devices.VERIZON: Any
  get() = object {
      /** DeviceSpec(manufacturer=VERIZON, code=QMV7A, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VERIZON, code=QMV7A, width=800,
