...
public val Devices.NOBRAND: Any
  get() = object {
      /** DeviceSpec(manufacturer=NOBRAND, code=stanford, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NOBRAND, code=stanford, width=720,
