...
public val Devices.Mswipe: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mswipe, code=L200, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mswipe, code=L200, width=720,
