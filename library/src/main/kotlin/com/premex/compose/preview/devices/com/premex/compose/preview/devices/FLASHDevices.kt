...
public val Devices.FLASH: Any
  get() = object {
      /** DeviceSpec(manufacturer=FLASH, code=PRIME_1, width=480, height=960, dpi=220,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FLASH, code=PRIME_1, width=480,
