...
public val Devices.TKDS: Any
  get() = object {
      /** DeviceSpec(manufacturer=TKDS, code=T_101H, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TKDS, code=T_101H, width=800,
