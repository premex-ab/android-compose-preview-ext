...
public val Devices.WOM: Any
  get() = object {
      /** DeviceSpec(manufacturer=WOM, code=SEI500W, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WOM, code=SEI500W, width=1080,
