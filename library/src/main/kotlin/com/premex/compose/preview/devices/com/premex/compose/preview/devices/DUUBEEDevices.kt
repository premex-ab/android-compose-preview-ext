...
public val Devices.DUUBEE: Any
  get() = object {
      /** DeviceSpec(manufacturer=DUUBEE, code=DT1052, width=1200, height=1920, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DUUBEE, code=DT1052, width=1200,
