...
public val Devices.CHOFSLIA: Any
  get() = object {
      /** DeviceSpec(manufacturer=CHOFSLIA, code=A6, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CHOFSLIA, code=A6, width=800,
