...
public val Devices.Creato: Any
  get() = object {
      /** DeviceSpec(manufacturer=Creato, code=mdt1005_mk_32, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Creato, code=mdt1005_mk_32,
