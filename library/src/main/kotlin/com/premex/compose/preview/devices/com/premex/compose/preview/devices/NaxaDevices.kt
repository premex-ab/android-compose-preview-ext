...
public val Devices.Naxa: Any
  get() = object {
      /** DeviceSpec(manufacturer=naxa, code=NID_1070, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=naxa, code=NID_1070, width=800,
