...
public val Devices.Softbank: Any
  get() = object {
      /** DeviceSpec(manufacturer=Softbank, code=501LV, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Softbank, code=501LV, width=800,
