...
public val Devices.TalkTalk: Any
  get() = object {
      /** DeviceSpec(manufacturer=TalkTalk, code=uzw4054ttg, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TalkTalk, code=uzw4054ttg,
