...
public val Devices.IDevice: Any
  get() = object {
      /** DeviceSpec(manufacturer=iDevice, code=Uzbekistan, width=720, height=1520, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=iDevice, code=Uzbekistan,
