...
public val Devices.ONDA: Any
  get() = object {
      /** DeviceSpec(manufacturer=ONDA, code=T9S, width=1080, height=2340, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ONDA, code=T9S, width=1080,
