...
public val Devices.TuCEL: Any
  get() = object {
      /** DeviceSpec(manufacturer=TuCEL, code=TL554B, width=640, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TuCEL, code=TL554B, width=640,
