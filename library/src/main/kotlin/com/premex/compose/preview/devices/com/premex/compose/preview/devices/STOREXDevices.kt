...
public val Devices.STOREX: Any
  get() = object {
      /** DeviceSpec(manufacturer=STOREX, code=MDDDI13310, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=STOREX, code=MDDDI13310, width=800,
      height=1280, dpi=160, isGoogleDevice=false).code */
      val MDDDI13310 = "spec:width=800,height=1280,unit=px,dpi=160"

      /** DeviceSpec(manufacturer=STOREX, code=MDDDI13311, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=STOREX, code=MDDDI13311, width=800,
      height=1280, dpi=160, isGoogleDevice=false).code */
