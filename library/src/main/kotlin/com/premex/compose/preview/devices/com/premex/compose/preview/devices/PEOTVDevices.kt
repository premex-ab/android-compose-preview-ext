...
public val Devices.PEOTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=PEOTV, code=SEI300SLT, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PEOTV, code=SEI300SLT, width=720,
