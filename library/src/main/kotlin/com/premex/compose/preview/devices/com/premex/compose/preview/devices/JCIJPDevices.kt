...
public val Devices.JCIJP: Any
  get() = object {
      /** DeviceSpec(manufacturer=JCI_JP, code=VA-10J, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=JCI_JP, code=VA-10J, width=720,
