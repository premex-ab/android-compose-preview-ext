...
public val Devices.HANET: Any
  get() = object {
      /** DeviceSpec(manufacturer=HANET, code=SmartEdu, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HANET, code=SmartEdu, width=800,
