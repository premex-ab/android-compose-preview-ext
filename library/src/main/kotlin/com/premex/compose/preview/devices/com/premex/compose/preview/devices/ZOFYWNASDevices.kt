...
public val Devices.ZOFYWNAS: Any
  get() = object {
      /** DeviceSpec(manufacturer=ZOFYWNAS, code=D10, width=1080, height=1920, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ZOFYWNAS, code=D10, width=1080,
