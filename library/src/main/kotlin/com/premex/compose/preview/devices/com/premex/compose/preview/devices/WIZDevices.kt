...
public val Devices.WIZ: Any
  get() = object {
      /** DeviceSpec(manufacturer=WIZ, code=Arc8, width=800, height=1280, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WIZ, code=Arc8, width=800,
      height=1280, dpi=240, isGoogleDevice=false).code */
      val ARC8 = "spec:width=800,height=1280,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=WIZ, code=Slate10, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WIZ, code=Slate10, width=1200,
