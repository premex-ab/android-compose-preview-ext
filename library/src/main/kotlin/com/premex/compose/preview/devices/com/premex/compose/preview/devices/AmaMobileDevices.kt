...
public val Devices.AmaMobile: Any
  get() = object {
      /** DeviceSpec(manufacturer=Ama-Mobile, code=AMAA703, width=600, height=1024, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Ama-Mobile, code=AMAA703,
