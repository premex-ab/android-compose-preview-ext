...
public val Devices.H800B: Any
  get() = object {
      /** DeviceSpec(manufacturer=H800B, code=RIGEL, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=H800B, code=RIGEL, width=800,
