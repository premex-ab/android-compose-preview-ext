...
public val Devices.SENSE: Any
  get() = object {
      /** DeviceSpec(manufacturer=SENSE, code=TW102, width=720, height=1560, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SENSE, code=TW102, width=720,
