...
public val Devices.CONSUNG: Any
  get() = object {
      /** DeviceSpec(manufacturer=CONSUNG, code=CS10L_PRO, width=800, height=1280, dpi=180,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CONSUNG, code=CS10L_PRO, width=800,
