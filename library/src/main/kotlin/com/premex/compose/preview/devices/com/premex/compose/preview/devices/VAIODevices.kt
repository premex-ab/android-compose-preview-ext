...
public val Devices.VAIO: Any
  get() = object {
      /** DeviceSpec(manufacturer=VAIO, code=VPA051, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=VAIO, code=VPA051, width=1080,
