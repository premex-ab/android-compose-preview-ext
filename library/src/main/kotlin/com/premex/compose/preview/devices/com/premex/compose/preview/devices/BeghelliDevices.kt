...
public val Devices.Beghelli: Any
  get() = object {
      /** DeviceSpec(manufacturer=Beghelli, code=SLV_SMARTPHONE_55, width=720, height=1440, dpi=360,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Beghelli, code=SLV_SMARTPHONE_55,
