...
public val Devices.Mint: Any
  get() = object {
      /** DeviceSpec(manufacturer=Mint, code=Mint_Triton, width=1080, height=2220, dpi=440,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Mint, code=Mint_Triton, width=1080,
