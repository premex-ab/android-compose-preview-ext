...
public val Devices.Planet: Any
  get() = object {
      /** DeviceSpec(manufacturer=Planet, code=Astro, width=1080, height=2340, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Planet, code=Astro, width=1080,
      height=2340, dpi=480, isGoogleDevice=false).code */
      val ASTRO = "spec:width=1080,height=2340,unit=px,dpi=480"

      /** DeviceSpec(manufacturer=Planet, code=Cosmo_Communicator, width=1080, height=2160, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Planet, code=Cosmo_Communicator,
      ...
      /** DeviceSpec(manufacturer=Planet, code=Gemini_4G, width=1080, height=2160, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Planet, code=Gemini_4G, width=1080,
