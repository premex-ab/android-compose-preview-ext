...
public val Devices.TIGERS: Any
  get() = object {
      /** DeviceSpec(manufacturer=TIGERS, code=TIS001-S3, width=480, height=960, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TIGERS, code=TIS001-S3, width=480,
      height=960, dpi=240, isGoogleDevice=false).code */
      val TIS001_S3 = "spec:width=480,height=960,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=TIGERS, code=TIS001_S4, width=480, height=960, dpi=220,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TIGERS, code=TIS001_S4, width=480,
