...
public val Devices.GeoMax: Any
  get() = object {
      /** DeviceSpec(manufacturer=GeoMax, code=Zenius08, width=1200, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GeoMax, code=Zenius08, width=1200,
