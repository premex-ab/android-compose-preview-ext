...
public val Devices.RAYOMOVIL: Any
  get() = object {
      /** DeviceSpec(manufacturer=RAYO_MOVIL, code=X1Plus, width=720, height=1600, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RAYO_MOVIL, code=X1Plus, width=720,
