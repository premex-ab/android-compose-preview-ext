...
public val Devices.Everex: Any
  get() = object {
      /** DeviceSpec(manufacturer=Everex, code=Fine_7B, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Everex, code=Fine_7B, width=600,
