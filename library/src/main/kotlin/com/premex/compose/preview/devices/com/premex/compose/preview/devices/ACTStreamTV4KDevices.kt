...
public val Devices.ACTStreamTV4K: Any
  get() = object {
      /** DeviceSpec(manufacturer=ACTStreamTV4K, code=HP40A, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ACTStreamTV4K, code=HP40A,
