...
public val Devices.Gateway: Any
  get() = object {
      /** DeviceSpec(manufacturer=gateway, code=G1-715, width=600, height=976, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=gateway, code=G1-715, width=600,
