...
public val Devices.Elitelux: Any
  get() = object {
      /** DeviceSpec(manufacturer=Elitelux, code=yeongdeungpo, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Elitelux, code=yeongdeungpo,
