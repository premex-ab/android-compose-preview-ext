...
public val Devices.Avion: Any
  get() = object {
      /** DeviceSpec(manufacturer=Avion, code=Avion_A10, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Avion, code=Avion_A10, width=720,
