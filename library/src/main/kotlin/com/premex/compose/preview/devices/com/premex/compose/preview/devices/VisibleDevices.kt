...
public val Devices.Visible: Any
  get() = object {
      /** DeviceSpec(manufacturer=Visible, code=WTVIS01, width=720, height=1600, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Visible, code=WTVIS01, width=720,
