...
public val Devices.Easyteck: Any
  get() = object {
      /** DeviceSpec(manufacturer=easyteck, code=EK12, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=easyteck, code=EK12, width=1200,
