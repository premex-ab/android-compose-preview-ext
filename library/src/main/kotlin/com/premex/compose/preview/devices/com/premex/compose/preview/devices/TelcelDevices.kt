...
public val Devices.Telcel: Any
  get() = object {
      /** DeviceSpec(manufacturer=telcel, code=i50F, width=480, height=854, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=telcel, code=i50F, width=480,
