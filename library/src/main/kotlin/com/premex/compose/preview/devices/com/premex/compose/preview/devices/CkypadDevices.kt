...
public val Devices.Ckypad: Any
  get() = object {
      /** DeviceSpec(manufacturer=Ckypad, code=Cpad10EEA, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Ckypad, code=Cpad10EEA, width=800,
