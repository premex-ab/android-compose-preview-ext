...
public val Devices.DOEL: Any
  get() = object {
      /** DeviceSpec(manufacturer=DOEL, code=TT_7_0, width=800, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DOEL, code=TT_7_0, width=800,
