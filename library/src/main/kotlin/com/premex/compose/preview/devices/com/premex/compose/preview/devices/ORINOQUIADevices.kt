...
public val Devices.ORINOQUIA: Any
  get() = object {
      /** DeviceSpec(manufacturer=ORINOQUIA, code=QAY221-U, width=320, height=480, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ORINOQUIA, code=QAY221-U,
