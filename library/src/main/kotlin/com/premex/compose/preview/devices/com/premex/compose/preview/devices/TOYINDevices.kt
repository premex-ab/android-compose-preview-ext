...
public val Devices.TOYIN: Any
  get() = object {
      /** DeviceSpec(manufacturer=TOYIN, code=RJ_TOYIN, width=480, height=854, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TOYIN, code=RJ_TOYIN, width=480,
