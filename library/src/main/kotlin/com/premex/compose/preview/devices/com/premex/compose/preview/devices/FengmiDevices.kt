...
public val Devices.Fengmi: Any
  get() = object {
      /** DeviceSpec(manufacturer=Fengmi, code=angleeUHD, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Fengmi, code=angleeUHD, width=1080,
