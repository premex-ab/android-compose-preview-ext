...
public val Devices.FLEXY: Any
  get() = object {
      /** DeviceSpec(manufacturer=FLEXY, code=pioneer, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FLEXY, code=pioneer, width=1080,
