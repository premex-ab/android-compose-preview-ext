...
public val Devices.ELDMandate: Any
  get() = object {
      /** DeviceSpec(manufacturer=ELDMandate, code=10BIZ332, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ELDMandate, code=10BIZ332,
