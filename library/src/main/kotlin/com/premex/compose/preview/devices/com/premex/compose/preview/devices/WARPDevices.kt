...
public val Devices.WARP: Any
  get() = object {
      /** DeviceSpec(manufacturer=WARP, code=TAB-WP11, width=1200, height=2000, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WARP, code=TAB-WP11, width=1200,
