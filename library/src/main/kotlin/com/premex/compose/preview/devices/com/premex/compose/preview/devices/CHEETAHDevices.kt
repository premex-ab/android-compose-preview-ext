...
public val Devices.CHEETAH: Any
  get() = object {
      /** DeviceSpec(manufacturer=CHEETAH, code=Diplomat, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CHEETAH, code=Diplomat, width=800,
