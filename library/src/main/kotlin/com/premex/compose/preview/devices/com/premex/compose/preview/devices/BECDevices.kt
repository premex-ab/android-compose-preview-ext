...
public val Devices.BEC: Any
  get() = object {
      /** DeviceSpec(manufacturer=BEC, code=longshan, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=BEC, code=longshan, width=1080,
