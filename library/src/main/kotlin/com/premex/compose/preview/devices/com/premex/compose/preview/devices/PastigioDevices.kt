...
public val Devices.Pastigio: Any
  get() = object {
      /** DeviceSpec(manufacturer=Pastigio, code=M10T2_P15, width=800, height=1280, dpi=200,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Pastigio, code=M10T2_P15,
