...
public val Devices.CRUA: Any
  get() = object {
      /** DeviceSpec(manufacturer=CRUA, code=mateo, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CRUA, code=mateo, width=720,
