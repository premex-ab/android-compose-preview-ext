...
public val Devices.EVOTA: Any
  get() = object {
      /** DeviceSpec(manufacturer=EVOTA, code=MTK9679, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=EVOTA, code=MTK9679, width=2160,
