...
public val Devices.ENTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=ENTV, code=seocho, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ENTV, code=seocho, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
      val SEOCHO = "spec:width=1080,height=1920,unit=px,dpi=320"

      /** DeviceSpec(manufacturer=ENTV, code=shilin, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ENTV, code=shilin, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
