...
public val Devices.Arcelik: Any
  get() = object {
      /** DeviceSpec(manufacturer=arcelik, code=arcelik_eu, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=arcelik, code=arcelik_eu,
