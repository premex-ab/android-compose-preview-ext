...
public val Devices.GOMDUSA: Any
  get() = object {
      /** DeviceSpec(manufacturer=GO_MD_USA, code=X23_Pro, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=GO_MD_USA, code=X23_Pro, width=800,
