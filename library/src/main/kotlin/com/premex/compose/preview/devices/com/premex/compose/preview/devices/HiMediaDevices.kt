...
public val Devices.HiMedia: Any
  get() = object {
      /** DeviceSpec(manufacturer=HiMedia, code=HiBox, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HiMedia, code=HiBox, width=1080,
