...
public val Devices.TekSavvyTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=TekSavvyTV, code=DV8219, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TekSavvyTV, code=DV8219,
