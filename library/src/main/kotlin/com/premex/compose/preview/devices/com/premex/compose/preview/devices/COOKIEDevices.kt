...
public val Devices.COOKIE: Any
  get() = object {
      /** DeviceSpec(manufacturer=COOKIE, code=YS-CK0001, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=COOKIE, code=YS-CK0001, width=1080,
