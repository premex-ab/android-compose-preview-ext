...
public val Devices.Hatch: Any
  get() = object {
      /** DeviceSpec(manufacturer=Hatch, code=Hatch_102S, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Hatch, code=Hatch_102S, width=1200,
      height=1920, dpi=240, isGoogleDevice=false).code */
      val HATCH_102S = "spec:width=1200,height=1920,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=Hatch, code=Hatch_103S, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Hatch, code=Hatch_103S, width=1200,
      height=1920, dpi=240, isGoogleDevice=false).code */
