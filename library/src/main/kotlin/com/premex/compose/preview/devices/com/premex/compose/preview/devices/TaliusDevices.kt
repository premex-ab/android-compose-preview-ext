...
public val Devices.Talius: Any
  get() = object {
      /** DeviceSpec(manufacturer=Talius, code=Zircon_1015, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Talius, code=Zircon_1015,
      width=800, height=1280, dpi=160, isGoogleDevice=false).code */
      val ZIRCON_1015 = "spec:width=800,height=1280,unit=px,dpi=160"

      /** DeviceSpec(manufacturer=Talius, code=Zircon_1016_4G, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Talius, code=Zircon_1016_4G,
