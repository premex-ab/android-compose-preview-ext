...
public val Devices.LISTO: Any
  get() = object {
      /** DeviceSpec(manufacturer=LISTO, code=yeongdeungpo, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LISTO, code=yeongdeungpo,
