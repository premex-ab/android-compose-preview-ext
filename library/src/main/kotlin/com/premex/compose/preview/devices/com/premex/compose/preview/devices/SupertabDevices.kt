...
public val Devices.Supertab: Any
  get() = object {
      /** DeviceSpec(manufacturer=Supertab, code=K7_KIDS, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Supertab, code=K7_KIDS, width=600,
      height=1024, dpi=160, isGoogleDevice=false).code */
      val K7_KIDS = "spec:width=600,height=1024,unit=px,dpi=160"

      /** DeviceSpec(manufacturer=Supertab, code=16G4H101, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Supertab, code=16G4H101, width=800,
