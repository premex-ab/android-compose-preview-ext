...
public val Devices.ASTON: Any
  get() = object {
      /** DeviceSpec(manufacturer=ASTON, code=Hyper_Max_Power, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ASTON, code=Hyper_Max_Power,
