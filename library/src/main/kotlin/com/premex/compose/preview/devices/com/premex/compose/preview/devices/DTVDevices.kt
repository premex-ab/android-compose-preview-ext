...
public val Devices.DTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=DTV, code=Digital_Life_P3, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DTV, code=Digital_Life_P3,
