...
public val Devices.IDEMIA: Any
  get() = object {
      /** DeviceSpec(manufacturer=IDEMIA, code=ID_Screen, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=IDEMIA, code=ID_Screen, width=800,
