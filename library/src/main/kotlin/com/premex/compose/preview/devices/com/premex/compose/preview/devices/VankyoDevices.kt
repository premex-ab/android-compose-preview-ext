...
public val Devices.Vankyo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Vankyo, code=P40, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Vankyo, code=P40, width=1200,
      height=1920, dpi=240, isGoogleDevice=false).code */
      val P40 = "spec:width=1200,height=1920,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=Vankyo, code=Z10, width=1200, height=1920, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Vankyo, code=Z10, width=1200,
