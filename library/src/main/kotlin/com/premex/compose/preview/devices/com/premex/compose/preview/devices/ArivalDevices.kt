...
public val Devices.Arival: Any
  get() = object {
      /** DeviceSpec(manufacturer=Arival, code=BioniQP116, width=1200, height=1920, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Arival, code=BioniQP116,
