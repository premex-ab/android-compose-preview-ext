...
public val Devices.TrueVision: Any
  get() = object {
      /** DeviceSpec(manufacturer=TrueVision, code=TV_A01, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TrueVision, code=TV_A01,
