...
public val Devices.MobiVista: Any
  get() = object {
      /** DeviceSpec(manufacturer=MobiVista, code=MVT_1001, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MobiVista, code=MVT_1001,
