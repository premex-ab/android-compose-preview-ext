...
public val Devices.HORIZON: Any
  get() = object {
      /** DeviceSpec(manufacturer=HORIZON, code=Interactive_White_Board, width=2160, height=3840,
      dpi=640, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HORIZON,
