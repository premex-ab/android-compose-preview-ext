...
public val Devices.RCT: Any
  get() = object {
      /** DeviceSpec(manufacturer=RCT, code=MX101M2, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RCT, code=MX101M2, width=800,
