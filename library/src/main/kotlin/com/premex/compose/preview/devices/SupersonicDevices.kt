 ...
 *
 * This extension provides Supersonic device specifications that can be used with @Preview annotations
 ...
 * \`\`\`
*/
val Devices.Supersonic get() = object {
    ...
    /** Supersonic SC-9810 */
    val SC_9810 = "spec:width=1200,height=1920,unit=px,dpi=240"
