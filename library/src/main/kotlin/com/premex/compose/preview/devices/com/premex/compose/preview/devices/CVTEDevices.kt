...
public val Devices.CVTE: Any
  get() = object {
      /** DeviceSpec(manufacturer=CVTE, code=rk3588_t, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CVTE, code=rk3588_t, width=2160,
