...
public val Devices.YELLYOUTH: Any
  get() = object {
      /** DeviceSpec(manufacturer=YELLYOUTH, code=TAB_101, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YELLYOUTH, code=TAB_101, width=800,
