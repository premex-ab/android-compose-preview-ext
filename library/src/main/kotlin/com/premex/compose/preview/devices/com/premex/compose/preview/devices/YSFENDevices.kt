...
public val Devices.YSFEN: Any
  get() = object {
      /** DeviceSpec(manufacturer=YSFEN, code=B9000, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=YSFEN, code=B9000, width=1080,
