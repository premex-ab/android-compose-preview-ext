...
public val Devices.MITSUSHIBA: Any
  get() = object {
      /** DeviceSpec(manufacturer=MITSUSHIBA, code=TP-10-0232P3G, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MITSUSHIBA, code=TP-10-0232P3G,
