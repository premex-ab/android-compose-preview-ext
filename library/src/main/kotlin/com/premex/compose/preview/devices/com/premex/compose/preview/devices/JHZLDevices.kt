...
public val Devices.JHZL: Any
  get() = object {
      /** DeviceSpec(manufacturer=JHZL, code=J101-EEA, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=JHZL, code=J101-EEA, width=800,
