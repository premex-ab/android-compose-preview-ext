...
public val Devices.BH: Any
  get() = object {
      /** DeviceSpec(manufacturer=BH, code=STB_B866V2H, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=BH, code=STB_B866V2H, width=720,
