...
public val Devices.COOCAA: Any
  get() = object {
      /** DeviceSpec(manufacturer=COOCAA, code=YDA, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=COOCAA, code=YDA, width=1080,
