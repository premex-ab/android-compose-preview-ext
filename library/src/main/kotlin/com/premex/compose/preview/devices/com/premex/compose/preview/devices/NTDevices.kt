...
public val Devices.NT: Any
  get() = object {
      /** DeviceSpec(manufacturer=NT, code=HP40A, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=NT, code=HP40A, width=1080,
