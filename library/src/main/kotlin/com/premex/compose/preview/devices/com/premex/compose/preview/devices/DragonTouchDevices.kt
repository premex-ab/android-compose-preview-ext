...
public val Devices.DragonTouch: Any
  get() = object {
      /** DeviceSpec(manufacturer=Dragon-Touch, code=X10A, width=768, height=1366, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Dragon-Touch, code=X10A, width=768,
