...
public val Devices.TelecabPlay: Any
  get() = object {
      /** DeviceSpec(manufacturer=TelecabPlay, code=B866V2FA_TELECAB, width=1080, height=1920,
      dpi=320, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TelecabPlay,
      code=B866V2FA_TELECAB, width=1080, height=1920, dpi=320, isGoogleDevice=false).code */
