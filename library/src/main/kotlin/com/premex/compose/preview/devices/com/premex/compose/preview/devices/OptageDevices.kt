...
public val Devices.Optage: Any
  get() = object {
      /** DeviceSpec(manufacturer=Optage, code=Amigo7xJP, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Optage, code=Amigo7xJP, width=1080,
