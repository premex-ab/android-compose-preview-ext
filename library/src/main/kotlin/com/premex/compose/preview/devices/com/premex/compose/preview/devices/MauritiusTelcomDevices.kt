...
public val Devices.MauritiusTelcom: Any
  get() = object {
      /** DeviceSpec(manufacturer=MauritiusTelcom, code=MTIPTVBox, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MauritiusTelcom, code=MTIPTVBox,
