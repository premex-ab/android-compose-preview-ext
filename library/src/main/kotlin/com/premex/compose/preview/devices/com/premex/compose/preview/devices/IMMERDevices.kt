...
public val Devices.IMMER: Any
  get() = object {
      /** DeviceSpec(manufacturer=IMMER, code=hongkong, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=IMMER, code=hongkong, width=1080,
