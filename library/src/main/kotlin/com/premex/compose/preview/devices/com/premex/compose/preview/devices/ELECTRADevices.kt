...
public val Devices.ELECTRA: Any
  get() = object {
      /** DeviceSpec(manufacturer=ELECTRA, code=elliniko, width=2160, height=3840, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ELECTRA, code=elliniko, width=2160,
