...
public val Devices.ACT: Any
  get() = object {
      /** DeviceSpec(manufacturer=ACT, code=IPBox, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ACT, code=IPBox, width=1080,
