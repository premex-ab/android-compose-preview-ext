...
public val Devices.OSN: Any
  get() = object {
      /** DeviceSpec(manufacturer=OSN, code=HY45N, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=OSN, code=HY45N, width=1080,
