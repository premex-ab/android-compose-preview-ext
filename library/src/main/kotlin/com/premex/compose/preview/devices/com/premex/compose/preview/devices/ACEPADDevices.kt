...
public val Devices.ACEPAD: Any
  get() = object {
      /** DeviceSpec(manufacturer=ACEPAD, code=A121, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ACEPAD, code=A121, width=800,
