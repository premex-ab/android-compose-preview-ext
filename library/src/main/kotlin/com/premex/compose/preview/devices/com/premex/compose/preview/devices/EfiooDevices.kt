...
public val Devices.Efioo: Any
  get() = object {
      /** DeviceSpec(manufacturer=efioo, code=efiootabn7a, width=600, height=1024, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=efioo, code=efiootabn7a, width=600,
