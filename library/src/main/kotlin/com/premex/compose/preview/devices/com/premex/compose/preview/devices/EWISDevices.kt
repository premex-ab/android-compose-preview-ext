...
public val Devices.EWIS: Any
  get() = object {
      /** DeviceSpec(manufacturer=EWIS, code=OCTA-T700M, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=EWIS, code=OCTA-T700M, width=800,
      height=1280, dpi=160, isGoogleDevice=false).code */
      val OCTA_T700M = "spec:width=800,height=1280,unit=px,dpi=160"

      /** DeviceSpec(manufacturer=EWIS, code=OCTA-T700M-T2, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=EWIS, code=OCTA-T700M-T2,
