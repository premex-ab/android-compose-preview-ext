...
public val Devices.BridgestoneMobilitySolutions: Any
  get() = object {
      /** DeviceSpec(manufacturer=Bridgestone_Mobility_Solutions, code=poseidon, width=800,
      height=1280, dpi=200, isGoogleDevice=false).manufacturer
      DeviceSpec(manufacturer=Bridgestone_Mobility_Solutions, code=poseidon, width=800, height=1280,
      dpi=200, isGoogleDevice=false).code */
