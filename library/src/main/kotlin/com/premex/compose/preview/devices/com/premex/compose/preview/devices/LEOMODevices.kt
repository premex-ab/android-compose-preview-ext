...
public val Devices.LEOMO: Any
  get() = object {
      /** DeviceSpec(manufacturer=LEOMO, code=LMS, width=240, height=400, dpi=120,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LEOMO, code=LMS, width=240,
      height=400, dpi=120, isGoogleDevice=false).code */
