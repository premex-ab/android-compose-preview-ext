 ...
 * ```
 */
public val Devices.Todos: Any
  get() = object {
      /** DeviceSpec(manufacturer=Todos, code=Tab64, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Todos, code=Tab64, width=800,
