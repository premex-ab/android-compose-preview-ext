...
public val Devices.Ioutdoor: Any
  get() = object {
      /** DeviceSpec(manufacturer=ioutdoor, code=Polar3, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ioutdoor, code=Polar3, width=720,
