...
public val Devices.SKYONE: Any
  get() = object {
      /** DeviceSpec(manufacturer=SKY-ONE, code=zhongshan, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SKY-ONE, code=zhongshan,
