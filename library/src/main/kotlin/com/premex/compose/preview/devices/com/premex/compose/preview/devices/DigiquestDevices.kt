...
public val Devices.Digiquest: Any
  get() = object {
      /** DeviceSpec(manufacturer=Digiquest, code=tamachi, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Digiquest, code=tamachi, width=720,
