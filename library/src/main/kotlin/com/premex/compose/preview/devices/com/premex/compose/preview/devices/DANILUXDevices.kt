...
public val Devices.DANILUX: Any
  get() = object {
      /** DeviceSpec(manufacturer=DANILUX, code=mountbaker, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DANILUX, code=mountbaker,
