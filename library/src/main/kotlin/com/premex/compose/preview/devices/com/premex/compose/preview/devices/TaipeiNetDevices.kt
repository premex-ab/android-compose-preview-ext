...
public val Devices.TaipeiNet: Any
  get() = object {
      /** DeviceSpec(manufacturer=TaipeiNet, code=HY40A3, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TaipeiNet, code=HY40A3, width=1080,
