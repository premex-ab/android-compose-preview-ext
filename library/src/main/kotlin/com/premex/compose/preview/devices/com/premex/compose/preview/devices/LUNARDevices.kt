...
public val Devices.LUNAR: Any
  get() = object {
      /** DeviceSpec(manufacturer=LUNAR, code=Lunar_Eclipse_L1, width=1080, height=2460, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LUNAR, code=Lunar_Eclipse_L1,
