...
public val Devices.Vivitek: Any
  get() = object {
      /** DeviceSpec(manufacturer=Vivitek, code=rk3576_u, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Vivitek, code=rk3576_u, width=2160,
