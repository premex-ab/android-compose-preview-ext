...
public val Devices.ARGUEST: Any
  get() = object {
      /** DeviceSpec(manufacturer=ARGUEST, code=kunyang, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=ARGUEST, code=kunyang, width=1080,
