...
public val Devices.Sunstech: Any
  get() = object {
      /** DeviceSpec(manufacturer=Sunstech, code=TAB1011, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Sunstech, code=TAB1011, width=800,
