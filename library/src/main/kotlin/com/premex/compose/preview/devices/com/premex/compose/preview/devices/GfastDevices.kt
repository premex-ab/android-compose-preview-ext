...
public val Devices.Gfast: Any
  get() = object {
      /** DeviceSpec(manufacturer=Gfast, code=MD_97_S464A, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Gfast, code=MD_97_S464A, width=800,
