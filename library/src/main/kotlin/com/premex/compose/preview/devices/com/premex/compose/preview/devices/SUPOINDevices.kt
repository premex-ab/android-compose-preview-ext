...
public val Devices.SUPOIN: Any
  get() = object {
      /** DeviceSpec(manufacturer=SUPOIN, code=S66, width=720, height=1440, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SUPOIN, code=S66, width=720,
