...
public val Devices.Guophone: Any
  get() = object {
      /** DeviceSpec(manufacturer=Guophone, code=Guophone_XP9800, width=640, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Guophone, code=Guophone_XP9800,
