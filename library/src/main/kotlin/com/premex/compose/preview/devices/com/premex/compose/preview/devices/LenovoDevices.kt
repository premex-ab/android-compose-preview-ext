...
public val Devices.Lenovo: Any
  get() = object {
      /** DeviceSpec(manufacturer=lenovo, code=manning, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=lenovo, code=manning, width=1080,
