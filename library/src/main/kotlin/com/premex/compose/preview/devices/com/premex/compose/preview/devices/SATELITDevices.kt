...
public val Devices.SATELIT: Any
  get() = object {
      /** DeviceSpec(manufacturer=SATELIT, code=mountbaker, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SATELIT, code=mountbaker,
