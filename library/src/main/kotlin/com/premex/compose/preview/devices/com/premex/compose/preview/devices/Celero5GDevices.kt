...
public val Devices.Celero5G: Any
  get() = object {
      /** DeviceSpec(manufacturer=Celero5G, code=Jupiter, width=720, height=1600, dpi=300,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Celero5G, code=Jupiter, width=720,
