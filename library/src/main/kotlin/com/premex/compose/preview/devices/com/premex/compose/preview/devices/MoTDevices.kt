...
public val Devices.MoT: Any
  get() = object {
      /** DeviceSpec(manufacturer=MoT, code=S22-8A, width=800, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MoT, code=S22-8A, width=800,
