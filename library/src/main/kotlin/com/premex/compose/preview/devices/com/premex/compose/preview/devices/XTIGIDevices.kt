...
public val Devices.XTIGI: Any
  get() = object {
      /** DeviceSpec(manufacturer=XTIGI, code=V51, width=540, height=1200, dpi=260,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=XTIGI, code=V51, width=540,
