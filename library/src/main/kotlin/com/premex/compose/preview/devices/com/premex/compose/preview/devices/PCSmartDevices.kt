...
public val Devices.PCSmart: Any
  get() = object {
      /** DeviceSpec(manufacturer=PC_Smart, code=PCSGOB10LTE-V2, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PC_Smart, code=PCSGOB10LTE-V2,
