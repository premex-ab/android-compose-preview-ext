...
public val Devices.RiksTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=RiksTV, code=HP40A3, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RiksTV, code=HP40A3, width=1080,
