...
public val Devices.RINDO: Any
  get() = object {
      /** DeviceSpec(manufacturer=RINDO, code=lasalle, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RINDO, code=lasalle, width=720,
