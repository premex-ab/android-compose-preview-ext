...
public val Devices.FAREASTONE: Any
  get() = object {
      /** DeviceSpec(manufacturer=FAREASTONE, code=Smart509, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FAREASTONE, code=Smart509,
      width=720, height=1280, dpi=320, isGoogleDevice=false).code */
      val SMART509 = "spec:width=720,height=1280,unit=px,dpi=320"

      /** DeviceSpec(manufacturer=FAREASTONE, code=Smart550, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FAREASTONE, code=Smart550,
      width=720, height=1280, dpi=320, isGoogleDevice=false).code */
