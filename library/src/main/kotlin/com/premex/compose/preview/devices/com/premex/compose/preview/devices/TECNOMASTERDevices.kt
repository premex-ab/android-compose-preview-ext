...
public val Devices.TECNOMASTER: Any
  get() = object {
      /** DeviceSpec(manufacturer=TECNOMASTER, code=TEC-M1310, width=1440, height=2160, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TECNOMASTER, code=TEC-M1310,
      width=1440, height=2160, dpi=240, isGoogleDevice=false).code */
