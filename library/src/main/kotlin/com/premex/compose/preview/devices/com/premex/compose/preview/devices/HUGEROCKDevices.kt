...
public val Devices.HUGEROCK: Any
  get() = object {
      /** DeviceSpec(manufacturer=HUGEROCK, code=E101, width=1080, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HUGEROCK, code=E101, width=1080,
