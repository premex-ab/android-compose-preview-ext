...
public val Devices.PINOCCHIO: Any
  get() = object {
      /** DeviceSpec(manufacturer=PINOCCHIO, code=SGWIFIPAD320093, width=800, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=PINOCCHIO, code=SGWIFIPAD320093,
