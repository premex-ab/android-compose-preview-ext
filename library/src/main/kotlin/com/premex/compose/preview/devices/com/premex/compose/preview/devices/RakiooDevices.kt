 ...
 * ```
 */
public val Devices.Rakioo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Rakioo, code=X5, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Rakioo, code=X5, width=600,
