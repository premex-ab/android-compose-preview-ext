...
public val Devices.FACILOTAB: Any
  get() = object {
      /** DeviceSpec(manufacturer=FACILOTAB, code=Facilotab_L_Rubis, width=1200, height=1920,
      dpi=240, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=FACILOTAB,
      code=Facilotab_L_Rubis, width=1200, height=1920, dpi=240, isGoogleDevice=false).code */
