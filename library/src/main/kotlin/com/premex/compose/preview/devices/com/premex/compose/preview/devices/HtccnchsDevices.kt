...
public val Devices.Htccnchs: Any
  get() = object {
      /** DeviceSpec(manufacturer=htccn_chs, code=dlxu, width=1080, height=1920, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=htccn_chs, code=dlxu, width=1080,
