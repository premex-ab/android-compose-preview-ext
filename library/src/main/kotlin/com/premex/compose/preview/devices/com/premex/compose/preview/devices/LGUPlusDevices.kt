...
public val Devices.LGUPlus: Any
  get() = object {
      /** DeviceSpec(manufacturer=LGUPlus, code=UHD4K, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=LGUPlus, code=UHD4K, width=1080,
