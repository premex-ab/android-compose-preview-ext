...
public val Devices.HumanAcademy: Any
  get() = object {
      /** DeviceSpec(manufacturer=Human_Academy, code=HA-008, width=800, height=1280, dpi=180,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Human_Academy, code=HA-008,
