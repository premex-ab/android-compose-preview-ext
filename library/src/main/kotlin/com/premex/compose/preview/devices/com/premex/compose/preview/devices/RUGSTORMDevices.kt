...
public val Devices.RUGSTORM: Any
  get() = object {
      /** DeviceSpec(manufacturer=RUGSTORM, code=UA80, width=800, height=1280, dpi=280,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=RUGSTORM, code=UA80, width=800,
