 ...
 *
 * This extension provides Safaricom device specifications that can be used with @Preview annotations
 ...
 * \`\`\`
*/
val Devices.Safaricom get() = object {
    /** Safaricom NEON LITE */
    ...
    val NEON_RAY_2_480X854 = "spec:width=480,height=854,unit=px,dpi=240"
