...
public val Devices.WILLETT: Any
  get() = object {
      /** DeviceSpec(manufacturer=WILLETT, code=tamachi, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=WILLETT, code=tamachi, width=720,
