...
public val Devices.AllVIEW: Any
  get() = object {
      /** DeviceSpec(manufacturer=AllVIEW, code=X6_Soul_mini, width=720, height=1520, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=AllVIEW, code=X6_Soul_mini,
