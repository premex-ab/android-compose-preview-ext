...
public val Devices.DWSUMMUS: Any
  get() = object {
      /** DeviceSpec(manufacturer=DWSUMMUS, code=marina, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DWSUMMUS, code=marina, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
      val MARINA = "spec:width=1080,height=1920,unit=px,dpi=320"

      /** DeviceSpec(manufacturer=DWSUMMUS, code=seocho, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DWSUMMUS, code=seocho, width=1080,
      height=1920, dpi=320, isGoogleDevice=false).code */
