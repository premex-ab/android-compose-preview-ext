...
public val Devices.PioneerDigitalTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=Pioneer_Digital_TV, code=DV8535-KIP, width=1080, height=1920,
      dpi=320, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Pioneer_Digital_TV,
      code=DV8535-KIP, width=1080, height=1920, dpi=320, isGoogleDevice=false).code */
