...
public val Devices.CIUSESRL: Any
  get() = object {
      /** DeviceSpec(manufacturer=CIUSE_SRL, code=CAB_TAB, width=600, height=1024, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CIUSE_SRL, code=CAB_TAB, width=600,
