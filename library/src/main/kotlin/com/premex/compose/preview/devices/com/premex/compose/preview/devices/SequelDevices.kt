...
public val Devices.Sequel: Any
  get() = object {
      /** DeviceSpec(manufacturer=Sequel, code=glowlight, width=390, height=390, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Sequel, code=glowlight, width=390,
