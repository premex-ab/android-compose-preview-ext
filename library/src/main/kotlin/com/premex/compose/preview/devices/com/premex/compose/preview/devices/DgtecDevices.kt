...
public val Devices.Dgtec: Any
  get() = object {
      /** DeviceSpec(manufacturer=Dgtec, code=DG101HSTB, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Dgtec, code=DG101HSTB, width=800,
