...
public val Devices.KAGIS: Any
  get() = object {
      /** DeviceSpec(manufacturer=KAGIS, code=yeongdeungpo, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=KAGIS, code=yeongdeungpo,
