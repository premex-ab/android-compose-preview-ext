...
public val Devices.WebfleetSolutions: Any
  get() = object {
      /** DeviceSpec(manufacturer=Webfleet_Solutions, code=triton, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Webfleet_Solutions, code=triton,
