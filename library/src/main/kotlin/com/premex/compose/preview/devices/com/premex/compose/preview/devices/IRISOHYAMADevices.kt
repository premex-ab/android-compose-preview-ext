...
public val Devices.IRISOHYAMA: Any
  get() = object {
      /** DeviceSpec(manufacturer=IRIS-OHYAMA, code=R4, width=720, height=1280, dpi=213,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=IRIS-OHYAMA, code=R4, width=720,
