...
public val Devices.MAXHUB: Any
  get() = object {
      /** DeviceSpec(manufacturer=MAXHUB, code=E3, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MAXHUB, code=E3, width=2160,
      height=3840, dpi=480, isGoogleDevice=false).code */
      val E3 = "spec:width=2160,height=3840,unit=px,dpi=480"

      /** DeviceSpec(manufacturer=MAXHUB, code=rk3588_t, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=MAXHUB, code=rk3588_t, width=2160,
      height=3840, dpi=480, isGoogleDevice=false).code */
