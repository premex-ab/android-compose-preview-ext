...
public val Devices.Optoma: Any
  get() = object {
      /** DeviceSpec(manufacturer=Optoma, code=rk3588_t, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Optoma, code=rk3588_t, width=2160,
