...
public val Devices.Alps: Any
  get() = object {
      /** DeviceSpec(manufacturer=alps, code=hct77_jb, width=480, height=800, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=alps, code=hct77_jb, width=480,
      height=800, dpi=240, isGoogleDevice=false).code */
      val HCT77_JB = "spec:width=480,height=800,unit=px,dpi=240"

      /** DeviceSpec(manufacturer=alps, code=8227L_demo, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=alps, code=8227L_demo, width=600,
