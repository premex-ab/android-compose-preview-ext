...
public val Devices.Myros: Any
  get() = object {
      /** DeviceSpec(manufacturer=Myros, code=E70_Ultra, width=1080, height=2340, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Myros, code=E70_Ultra, width=1080,
