...
public val Devices.Porsche: Any
  get() = object {
      /** DeviceSpec(manufacturer=Porsche, code=sdis1, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Porsche, code=sdis1, width=1200,
