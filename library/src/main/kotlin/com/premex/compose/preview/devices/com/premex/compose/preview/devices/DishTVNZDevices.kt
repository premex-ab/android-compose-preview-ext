...
public val Devices.DishTVNZ: Any
  get() = object {
      /** DeviceSpec(manufacturer=DishTV-NZ, code=HiCast, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=DishTV-NZ, code=HiCast, width=1080,
