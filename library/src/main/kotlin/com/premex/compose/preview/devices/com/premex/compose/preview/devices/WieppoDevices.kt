...
public val Devices.Wieppo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Wieppo, code=t596_jw_wieppo, width=720, height=1280, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Wieppo, code=t596_jw_wieppo,
