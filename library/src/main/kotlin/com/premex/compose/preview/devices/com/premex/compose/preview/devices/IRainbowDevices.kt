...
public val Devices.IRainbow: Any
  get() = object {
      /** DeviceSpec(manufacturer=iRainbow, code=B12017, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=iRainbow, code=B12017, width=800,
