...
public val Devices.Mitsubishi: Any
  get() = object {
      /** DeviceSpec(manufacturer=mitsubishi, code=aivi2_r_full_dom, width=960, height=1280,
      dpi=160, isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=mitsubishi,
      code=aivi2_r_full_dom, width=960, height=1280, dpi=160, isGoogleDevice=false).code */
