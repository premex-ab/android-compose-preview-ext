...
public val Devices.Starboard: Any
  get() = object {
      /** DeviceSpec(manufacturer=Starboard, code=YL, width=2160, height=3840, dpi=480,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Starboard, code=YL, width=2160,
