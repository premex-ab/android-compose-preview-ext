...
public val Devices.TwinMOS: Any
  get() = object {
      /** DeviceSpec(manufacturer=TwinMOS, code=MQ703G, width=600, height=1024, dpi=220,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TwinMOS, code=MQ703G, width=600,
      height=1024, dpi=220, isGoogleDevice=false).code */
      val MQ703G = "spec:width=600,height=1024,unit=px,dpi=220"

      /** DeviceSpec(manufacturer=TwinMOS, code=MQ703G_1, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=TwinMOS, code=MQ703G_1, width=600,
