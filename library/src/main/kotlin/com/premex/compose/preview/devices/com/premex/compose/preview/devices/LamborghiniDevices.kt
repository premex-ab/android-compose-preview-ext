...
public val Devices.Lamborghini: Any
  get() = object {
      /** DeviceSpec(manufacturer=Lamborghini, code=sdis1, width=1200, height=1920, dpi=240,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Lamborghini, code=sdis1,
