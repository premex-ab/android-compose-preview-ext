...
public val Devices.HOPE: Any
  get() = object {
      /** DeviceSpec(manufacturer=HOPE, code=HOPE_S25u, width=720, height=1600, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=HOPE, code=HOPE_S25u, width=720,
