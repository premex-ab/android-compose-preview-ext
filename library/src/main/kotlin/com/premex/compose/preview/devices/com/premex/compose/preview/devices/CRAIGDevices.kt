...
public val Devices.CRAIG: Any
  get() = object {
      /** DeviceSpec(manufacturer=CRAIG, code=CMP846, width=800, height=1280, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=CRAIG, code=CMP846, width=800,
