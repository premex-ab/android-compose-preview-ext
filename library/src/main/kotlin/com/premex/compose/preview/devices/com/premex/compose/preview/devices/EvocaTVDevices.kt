...
public val Devices.EvocaTV: Any
  get() = object {
      /** DeviceSpec(manufacturer=EvocaTV, code=f511, width=1080, height=1920, dpi=320,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=EvocaTV, code=f511, width=1080,
