...
public val Devices.Soymomo: Any
  get() = object {
      /** DeviceSpec(manufacturer=Soymomo, code=SoyMomo_Lite_V1, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=Soymomo, code=SoyMomo_Lite_V1,
