...
public val Devices.SMARTEC: Any
  get() = object {
      /** DeviceSpec(manufacturer=SMARTEC, code=SmartabS4, width=600, height=1024, dpi=160,
      isGoogleDevice=false).manufacturer DeviceSpec(manufacturer=SMARTEC, code=SmartabS4, width=600,
