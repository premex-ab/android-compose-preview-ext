...
Total: **24** devices. Import: `import se.premex.compose.preview.device.catalog.android.Starlight`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| Alpha_100 | ALPHA_100 | 720x1520 | 280 | `spec:width=720px,height=1520px,dpi=280` | `@Preview(device = Starlight.ALPHA_100)` |
| Alpha_200 | ALPHA_200 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Starlight.ALPHA_200)` |
...
| C_Note | C_NOTE | 1080x1920 | 480 | `spec:width=1080px,height=1920px,dpi=480` | `@Preview(device = Starlight.C_NOTE)` |
