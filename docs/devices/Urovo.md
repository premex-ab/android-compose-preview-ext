...
Total: **13** devices. Import: `import se.premex.compose.preview.device.catalog.android.Urovo`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| CT58S | CT58S | 720x1440 | 320 | `spec:width=720px,height=1440px,dpi=320` | `@Preview(device = Urovo.CT58S)` |
...
| P8100 | P8100 | 800x1280 | 210 | `spec:width=800px,height=1280px,dpi=210` | `@Preview(device = Urovo.P8100)` |
