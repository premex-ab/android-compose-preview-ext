...
Total: **15** devices. Import: `import se.premex.compose.preview.device.catalog.android.Dmoao`
...
| D3_V_EEA | D3_V_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dmoao.D3_V_EEA)` |
| D3_V_US | D3_V_US | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dmoao.D3_V_US)` |
...
| D7_EEA | D7_EEA | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Dmoao.D7_EEA)` |
| D7_US | D7_US | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Dmoao.D7_US)` |
