...
Total: **33** devices. Import: `import se.premex.compose.preview.device.catalog.android.Azumi`
...
| Azumi_V5_AC25B | AZUMI_V5_AC25B | 480x854 | 240 | `spec:width=480px,height=854px,dpi=240` | `@Preview(device = Azumi.AZUMI_V5_AC25B)` |
| Azumi_V5_AC25S | AZUMI_V5_AC25S | 480x854 | 240 | `spec:width=480px,height=854px,dpi=240` | `@Preview(device = Azumi.AZUMI_V5_AC25S)` |
