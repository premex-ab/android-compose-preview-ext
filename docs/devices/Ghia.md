...
Total: **44** devices. Import: `import se.premex.compose.preview.device.catalog.android.Ghia`
...
| GK133S24 | GK133S24 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Ghia.GK133S24)` |
...
| GK133U24 | GK133U24 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Ghia.GK133U24)` |
| GK133V3 | GK133V3 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Ghia.GK133V3)` |
| GK333P25 | GK333P25 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Ghia.GK333P25)` |
| GK523A24 | GK523A24 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Ghia.GK523A24)` |
| GK537 | GK537 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Ghia.GK537)` |
| GP333 | GP333 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Ghia.GP333)` |
