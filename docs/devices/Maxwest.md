...
| MX-A67WW | MX_A67WW | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Maxwest.MX_A67WW)` |
| MX-A6T | MX_A6T | 480x960 | 213 | `spec:width=480px,height=960px,dpi=213` | `@Preview(device = Maxwest.MX_A6T)` |
| MX-AA8WW01 | MX_AA8WW01 | 800x1280 | 240 | `spec:width=800px,height=1280px,dpi=240` | `@Preview(device = Maxwest.MX_AA8WW01)` |
...
| MX-GG68WW | MX_GG68WW | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Maxwest.MX_GG68WW)` |
