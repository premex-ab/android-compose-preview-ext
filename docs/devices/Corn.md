...
Total: **30** devices. Import: `import se.premex.compose.preview.device.catalog.android.Corn`
...
| Coco20_Ultra_4G | COCO20_ULTRA_4G | 720x1560 | 480 | `spec:width=720px,height=1560px,dpi=480` | `@Preview(device = Corn.COCO20_ULTRA_4G)` |
...
| Star9_Max | STAR9_MAX | 800x1340 | 213 | `spec:width=800px,height=1340px,dpi=213` | `@Preview(device = Corn.STAR9_MAX)` |
| Star9_Pro | STAR9_PRO | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Corn.STAR9_PRO)` |
