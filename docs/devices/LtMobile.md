...
Total: **11** devices. Import: `import se.premex.compose.preview.device.catalog.android.LtMobile`
...
| LT_mobile_C27 | LT_MOBILE_C27 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = LtMobile.LT_MOBILE_C27)` |
...
| LT_mobile_K80 | LT_MOBILE_K80 | 1080x2400 | 480 | `spec:width=1080px,height=2400px,dpi=480` | `@Preview(device = LtMobile.LT_MOBILE_K80)` |
...
| LT_mobile_S40 | LT_MOBILE_S40 | 1080x2460 | 480 | `spec:width=1080px,height=2460px,dpi=480` | `@Preview(device = LtMobile.LT_MOBILE_S40)` |
