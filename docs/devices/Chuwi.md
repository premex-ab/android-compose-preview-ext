...
Total: **19** devices. Import: `import se.premex.compose.preview.device.catalog.android.Chuwi`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| AuPad | AUPAD | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Chuwi.AUPAD)` |
| AupadMini | AUPADMINI | 800x1340 | 213 | `spec:width=800px,height=1340px,dpi=213` | `@Preview(device = Chuwi.AUPADMINI)` |
...
| HiPad_Max | HIPAD_MAX | 1080x2248 | 480 | `spec:width=1080px,height=2248px,dpi=480` | `@Preview(device = Chuwi.HIPAD_MAX)` |
