...
|------|----------|------------|-----|-------------|---------------|
| aalter | AALTER | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Konka.AALTER)` |
...
| clara | CLARA | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Konka.CLARA)` |
