...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Dghrti`
...
| TAB30-EU | TAB30_EU | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dghrti.TAB30_EU)` |
| TAB30-W | TAB30_W | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dghrti.TAB30_W)` |
