...
Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Proton`
...
| Infinity_8 | INFINITY_8 | 720x1640 | 480 | `spec:width=720px,height=1640px,dpi=480` | `@Preview(device = Proton.INFINITY_8)` |
