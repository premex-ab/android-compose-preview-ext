...
Total: **116** devices. Import: `import se.premex.compose.preview.device.catalog.android.Dexp`
...
| D11 | D11 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dexp.D11)` |
