...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Syinix`
...
| eleonas | ELEONAS | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Syinix.ELEONAS)` |
