# Deutschetelekom Devices

Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Deutschetelekom`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| BELUGA | BELUGA | 1200x1920 | 320 | `spec:width=1200px,height=1920px,dpi=320` | `@Preview(device = Deutschetelekom.BELUGA)` |
...
| Lynx | LYNX | 1080x2408 | 480 | `spec:width=1080px,height=2408px,dpi=480` | `@Preview(device = Deutschetelekom.LYNX)` |
