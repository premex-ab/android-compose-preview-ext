...
Total: **18** devices. Import: `import se.premex.compose.preview.device.catalog.android.Pcd`
...
| C58_ARG | C58_ARG | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Pcd.C58_ARG)` |
...
| P65L | P65L | 576x1280 | 260 | `spec:width=576px,height=1280px,dpi=260` | `@Preview(device = Pcd.P65L)` |
