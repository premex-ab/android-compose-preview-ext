...
Total: **33** devices. Import: `import se.premex.compose.preview.device.catalog.android.Vertex`
...
| Interactive-Multimedia-Display | INTERACTIVE_MULTIMEDIA_DISPLAY | 2160x3840 | 480 | `spec:width=2160px,height=3840px,dpi=480` | `@Preview(device = Vertex.INTERACTIVE_MULTIMEDIA_DISPLAY)` |
