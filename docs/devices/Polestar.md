...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Polestar`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| ihu42 | IHU42 | 1152x1536 | 180 | `spec:width=1152px,height=1536px,dpi=180` | `@Preview(device = Polestar.IHU42)` |
