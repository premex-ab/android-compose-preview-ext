...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Simi`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| COOL2 | COOL2 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Simi.COOL2)` |
| DREAM2 | DREAM2 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Simi.DREAM2)` |
