...
Total: **5** devices. Import: `import se.premex.compose.preview.device.catalog.android.Lifephone`
...
| LIFEPHONE_SIMPLE | LIFEPHONE_SIMPLE | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Lifephone.LIFEPHONE_SIMPLE)` |
