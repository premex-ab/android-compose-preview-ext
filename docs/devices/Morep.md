...
Total: **6** devices. Import: `import se.premex.compose.preview.device.catalog.android.Morep`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| Mavic_10 | MAVIC_10 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Morep.MAVIC_10)` |
| mavic_20 | MAVIC_20 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Morep.MAVIC_20)` |
...
| morep_v5 | MOREP_V5 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Morep.MOREP_V5)` |
