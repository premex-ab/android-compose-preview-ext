...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Trekstor`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| SurfTab | SURFTAB | 600x1024 | 213 | `spec:width=600px,height=1024px,dpi=213` | `@Preview(device = Trekstor.SURFTAB)` |
