...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Helio`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| helio_15 | HELIO_15 | 720x1600 | 280 | `spec:width=720px,height=1600px,dpi=280` | `@Preview(device = Helio.HELIO_15)` |
| helio_40 | HELIO_40 | 720x1604 | 280 | `spec:width=720px,height=1604px,dpi=280` | `@Preview(device = Helio.HELIO_40)` |
| helio_45 | HELIO_45 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Helio.HELIO_45)` |
