...
Total: **43** devices. Import: `import se.premex.compose.preview.device.catalog.android.Logic`
...
| L65E | L65E | 576x1280 | 240 | `spec:width=576px,height=1280px,dpi=240` | `@Preview(device = Logic.L65E)` |
...
| L66F | L66F | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Logic.L66F)` |
...
| LOGIC_L55V | LOGIC_L55V | 480x960 | 240 | `spec:width=480px,height=960px,dpi=240` | `@Preview(device = Logic.LOGIC_L55V)` |
