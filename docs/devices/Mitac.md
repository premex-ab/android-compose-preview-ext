...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Mitac`
...
| phaeton | PHAETON | 800x1280 | 180 | `spec:width=800px,height=1280px,dpi=180` | `@Preview(device = Mitac.PHAETON)` |
