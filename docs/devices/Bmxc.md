...
Total: **6** devices. Import: `import se.premex.compose.preview.device.catalog.android.Bmxc`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| BM108 | BM108 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Bmxc.BM108)` |
| K107 | K107 | 800x1280 | 210 | `spec:width=800px,height=1280px,dpi=210` | `@Preview(device = Bmxc.K107)` |
