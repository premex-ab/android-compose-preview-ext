...
Total: **23** devices. Import: `import se.premex.compose.preview.device.catalog.android.Headwolf`
...
| F8 | F8 | 1600x2560 | 320 | `spec:width=1600px,height=2560px,dpi=320` | `@Preview(device = Headwolf.F8)` |
...
| Hpad2 | HPAD2 | 1200x2000 | 280 | `spec:width=1200px,height=2000px,dpi=280` | `@Preview(device = Headwolf.HPAD2)` |
...
| W6B | W6B | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Headwolf.W6B)` |
