...
Total: **14** devices. Import: `import se.premex.compose.preview.device.catalog.android.Idata`
...
| iData_P1 | IDATA_P1 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = Idata.IDATA_P1)` |
| iData_T1_UHF | IDATA_T1_UHF | 720x1440 | 320 | `spec:width=720px,height=1440px,dpi=320` | `@Preview(device = Idata.IDATA_T1_UHF)` |
| iData_T1S | IDATA_T1S | 720x1440 | 320 | `spec:width=720px,height=1440px,dpi=320` | `@Preview(device = Idata.IDATA_T1S)` |
