...
Total: **17** devices. Import: `import se.premex.compose.preview.device.catalog.android.Energizer`
...
| U652S_PLUS | U652S_PLUS | 576x1280 | 240 | `spec:width=576px,height=1280px,dpi=240` | `@Preview(device = Energizer.U652S_PLUS)` |
| U683S | U683S | 720x1640 | 280 | `spec:width=720px,height=1640px,dpi=280` | `@Preview(device = Energizer.U683S)` |
