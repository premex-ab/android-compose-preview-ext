...
Total: **17** devices. Import: `import se.premex.compose.preview.device.catalog.android.Goodtel`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| G10 | G10 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Goodtel.G10)` |
| G10_EEA | G10_EEA | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Goodtel.G10_EEA)` |
...
| G9 | G9 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Goodtel.G9)` |
