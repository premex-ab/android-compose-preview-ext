...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Homtom`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| C2 | C2 | 640x1280 | 320 | `spec:width=640px,height=1280px,dpi=320` | `@Preview(device = Homtom.C2)` |
| H10 | H10 | 720x1512 | 320 | `spec:width=720px,height=1512px,dpi=320` | `@Preview(device = Homtom.H10)` |
...
| S16 | S16 | 640x1280 | 320 | `spec:width=640px,height=1280px,dpi=320` | `@Preview(device = Homtom.S16)` |
