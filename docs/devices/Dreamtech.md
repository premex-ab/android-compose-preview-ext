...
Total: **6** devices. Import: `import se.premex.compose.preview.device.catalog.android.Dreamtech`
...
| KIDDOTAB8 | KIDDOTAB8 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Dreamtech.KIDDOTAB8)` |
