...
Total: **88** devices. Import: `import se.premex.compose.preview.device.catalog.android.Logicom`
...
| LOGIKIDS_STAR | LOGIKIDS_STAR | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Logicom.LOGIKIDS_STAR)` |
...
| LYRA | LYRA | 540x1092 | 213 | `spec:width=540px,height=1092px,dpi=213` | `@Preview(device = Logicom.LYRA)` |
...
| TAB_FOLD_12 | TAB_FOLD_12 | 1200x2000 | 320 | `spec:width=1200px,height=2000px,dpi=320` | `@Preview(device = Logicom.TAB_FOLD_12)` |
...
| Xtrem650 | XTREM650 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Logicom.XTREM650)` |
