...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Bleck`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| BE_dg | BE_DG | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Bleck.BE_DG)` |
