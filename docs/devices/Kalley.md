...
Total: **32** devices. Import: `import se.premex.compose.preview.device.catalog.android.Kalley`
...
| Black_6C | BLACK_6C | 1080x2400 | 480 | `spec:width=1080px,height=2400px,dpi=480` | `@Preview(device = Kalley.BLACK_6C)` |
...
| Black_E2 | BLACK_E2 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Kalley.BLACK_E2)` |
...
| Black_G4 | BLACK_G4 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Kalley.BLACK_G4)` |
...
| Black_Z2 | BLACK_Z2 | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Kalley.BLACK_Z2)` |
