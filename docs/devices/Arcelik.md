...
Total: **11** devices. Import: `import se.premex.compose.preview.device.catalog.android.Arcelik`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| aberdeen | ABERDEEN | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Arcelik.ABERDEEN)` |
...
| awaza | AWAZA | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Arcelik.AWAZA)` |
...
| millbrae | MILLBRAE | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Arcelik.MILLBRAE)` |
