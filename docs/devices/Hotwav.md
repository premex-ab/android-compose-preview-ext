...
Total: **53** devices. Import: `import se.premex.compose.preview.device.catalog.android.Hotwav`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| A17_Pro_Max | A17_PRO_MAX | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Hotwav.A17_PRO_MAX)` |
| A56 | A56 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Hotwav.A56)` |
...
| Cyber_16_Pro | CYBER_16_PRO | 1080x2408 | 480 | `spec:width=1080px,height=2408px,dpi=480` | `@Preview(device = Hotwav.CYBER_16_PRO)` |
...
| Hyper_7S | HYPER_7S | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Hotwav.HYPER_7S)` |
...
| Note15 | NOTE15 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Hotwav.NOTE15)` |
...
| Note_18_GT | NOTE_18_GT | 720x1560 | 320 | `spec:width=720px,height=1560px,dpi=320` | `@Preview(device = Hotwav.NOTE_18_GT)` |
| Note_18_Pro | NOTE_18_PRO | 720x1560 | 320 | `spec:width=720px,height=1560px,dpi=320` | `@Preview(device = Hotwav.NOTE_18_PRO)` |
...
| Symbol_Max | SYMBOL_MAX | 1440x2960 | 560 | `spec:width=1440px,height=2960px,dpi=560` | `@Preview(device = Hotwav.SYMBOL_MAX)` |
...
| TAB_R10_Pro | TAB_R10_PRO | 800x1280 | 280 | `spec:width=800px,height=1280px,dpi=280` | `@Preview(device = Hotwav.TAB_R10_PRO)` |
