...
Total: **22** devices. Import: `import se.premex.compose.preview.device.catalog.android.Kxd`
...
| T50Y | T50Y | 240x284 | 120 | `spec:width=240px,height=284px,dpi=120` | `@Preview(device = Kxd.T50Y)` |
...
| X7s | X7S | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Kxd.X7S)` |
