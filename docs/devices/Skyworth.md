...
Total: **15** devices. Import: `import se.premex.compose.preview.device.catalog.android.Skyworth`
...
| katehaki | KATEHAKI | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Skyworth.KATEHAKI)` |
...
| YDA | YDA | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Skyworth.YDA)` |
