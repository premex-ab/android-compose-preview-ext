...
Total: **33** devices. Import: `import se.premex.compose.preview.device.catalog.android.Atozee`
...
| CP10_Pro | CP10_PRO | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Atozee.CP10_PRO)` |
...
| CP20_PRO | CP20_PRO | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Atozee.CP20_PRO)` |
...
| Q2S_Pro | Q2S_PRO | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Atozee.Q2S_PRO)` |
...
| YQ10S_MAX | YQ10S_MAX | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Atozee.YQ10S_MAX)` |
