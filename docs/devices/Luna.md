...
| LUNA_T10 | LUNA_T10 | 720x1612 | 320 | `spec:width=720px,height=1612px,dpi=320` | `@Preview(device = Luna.LUNA_T10)` |
| LUNA_V6 | LUNA_V6 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Luna.LUNA_V6)` |
