...
Total: **3** devices. Import: `import se.premex.compose.preview.device.catalog.android.Arknikko`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| MemoPad_T3_EEA | MEMOPAD_T3_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Arknikko.MEMOPAD_T3_EEA)` |
