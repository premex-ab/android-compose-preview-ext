...
Total: **38** devices. Import: `import se.premex.compose.preview.device.catalog.android.Thomson`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| anaheim | ANAHEIM | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Thomson.ANAHEIM)` |
| Delight_TH201 | DELIGHT_TH201 | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Thomson.DELIGHT_TH201)` |
| dongnae | DONGNAE | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Thomson.DONGNAE)` |
...
| sepolia | SEPOLIA | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Thomson.SEPOLIA)` |
...
| TEO13M | TEO13M | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Thomson.TEO13M)` |
...
| Thomson_Go | THOMSON_GO | 2160x3840 | 540 | `spec:width=2160px,height=3840px,dpi=540` | `@Preview(device = Thomson.THOMSON_GO)` |
