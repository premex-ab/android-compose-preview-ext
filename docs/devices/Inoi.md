...
| INOI_A55_Spectre_5G | INOI_A55_SPECTRE_5G | 720x1604 | 320 | `spec:width=720px,height=1604px,dpi=320` | `@Preview(device = Inoi.INOI_A55_SPECTRE_5G)` |
...
| INOI_Note_15 | INOI_NOTE_15 | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Inoi.INOI_NOTE_15)` |
