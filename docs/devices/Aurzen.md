...
Total: **5** devices. Import: `import se.premex.compose.preview.device.catalog.android.Aurzen`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| coorg | COORG | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Aurzen.COORG)` |
| himalaya | HIMALAYA | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Aurzen.HIMALAYA)` |
