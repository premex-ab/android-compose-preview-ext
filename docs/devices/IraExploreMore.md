# IraExploreMore Devices

Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.IraExploreMore`
...
| IRA_BIOA | IRA_BIOA | 600x1024 | 213 | `spec:width=600px,height=1024px,dpi=213` | `@Preview(device = IraExploreMore.IRA_BIOA)` |
...
| IRA_T803M | IRA_T803M | 800x1280 | 240 | `spec:width=800px,height=1280px,dpi=240` | `@Preview(device = IraExploreMore.IRA_T803M)` |
