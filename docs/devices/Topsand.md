...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Topsand`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| G12_A14 | G12_A14 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Topsand.G12_A14)` |
| G12_Pro | G12_PRO | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Topsand.G12_PRO)` |
