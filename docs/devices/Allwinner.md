...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Allwinner`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| apollo-p7 | APOLLO_P7 | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Allwinner.APOLLO_P7)` |
| ceres-b3 | CERES_B3 | 720x1280 | 160 | `spec:width=720px,height=1280px,dpi=160` | `@Preview(device = Allwinner.CERES_B3)` |
