...
Total: **5** devices. Import: `import se.premex.compose.preview.device.catalog.android.Alt`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| L1 | L1 | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Alt.L1)` |
