...
Total: **5** devices. Import: `import se.premex.compose.preview.device.catalog.android.Imose`
...
| OPOR | OPOR | 800x1280 | 240 | `spec:width=800px,height=1280px,dpi=240` | `@Preview(device = Imose.OPOR)` |
