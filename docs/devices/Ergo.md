...
Total: **10** devices. Import: `import se.premex.compose.preview.device.catalog.android.Ergo`
...
| beomil | BEOMIL | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Ergo.BEOMIL)` |
| byculla | BYCULLA | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Ergo.BYCULLA)` |
| eleonas | ELEONAS | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Ergo.ELEONAS)` |
