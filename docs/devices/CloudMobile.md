...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.CloudMobile`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| MC8B654B | MC8B654B | 720x1612 | 260 | `spec:width=720px,height=1612px,dpi=260` | `@Preview(device = CloudMobile.MC8B654B)` |
