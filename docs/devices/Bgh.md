...
Total: **11** devices. Import: `import se.premex.compose.preview.device.catalog.android.Bgh`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| BGH_Joy_303 | BGH_JOY_303 | 480x854 | 240 | `spec:width=480px,height=854px,dpi=240` | `@Preview(device = Bgh.BGH_JOY_303)` |
| eleonas | ELEONAS | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Bgh.ELEONAS)` |
