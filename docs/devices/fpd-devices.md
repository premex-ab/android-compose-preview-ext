...
This document lists all Fpd device specifications available for Android Compose previews.

## Overview

- **Total devices**: 6
- **Manufacturer**: Fpd
- **Usage**: `Devices.Fpd.DEVICE_NAME`
...
@Preview(device = Devices.Fpd.ELLINIKO)
@Composable
fun MyPreview() {
