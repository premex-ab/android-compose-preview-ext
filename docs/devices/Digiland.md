...
Total: **14** devices. Import: `import se.premex.compose.preview.device.catalog.android.Digiland`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| DL1001 | DL1001 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Digiland.DL1001)` |
| DL1036 | DL1036 | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Digiland.DL1036)` |
