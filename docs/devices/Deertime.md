...
Total: **12** devices. Import: `import se.premex.compose.preview.device.catalog.android.Deertime`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| E10_EEA | E10_EEA | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Deertime.E10_EEA)` |
| E11_EEA | E11_EEA | 800x1340 | 213 | `spec:width=800px,height=1340px,dpi=213` | `@Preview(device = Deertime.E11_EEA)` |
...
| E15_V_EEA | E15_V_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Deertime.E15_V_EEA)` |
| E15_V_US | E15_V_US | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Deertime.E15_V_US)` |
...
| E9-EU | E9_EU | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Deertime.E9_EU)` |
| E9-W | E9_W | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Deertime.E9_W)` |
