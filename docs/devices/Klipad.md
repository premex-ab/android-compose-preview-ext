...
Total: **32** devices. Import: `import se.premex.compose.preview.device.catalog.android.Klipad`
...
| KL4891 | KL4891 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Klipad.KL4891)` |
...
| KL4899A | KL4899A | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Klipad.KL4899A)` |
