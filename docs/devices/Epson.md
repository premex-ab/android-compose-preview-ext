...
Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Epson`
...
| kasauli | KASAULI | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Epson.KASAULI)` |
| kodaikanal | KODAIKANAL | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Epson.KODAIKANAL)` |
| ooty | OOTY | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Epson.OOTY)` |
