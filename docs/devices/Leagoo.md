...
Total: **26** devices. Import: `import se.premex.compose.preview.device.catalog.android.Leagoo`
...
| M13 | M13 | 1080x2220 | 560 | `spec:width=1080px,height=2220px,dpi=560` | `@Preview(device = Leagoo.M13)` |
