...
Total: **10** devices. Import: `import se.premex.compose.preview.device.catalog.android.Supersonic`
...
| SC_4107 | SC_4107 | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Supersonic.SC_4107)` |
| SC_4110 | SC_4110 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Supersonic.SC_4110)` |
