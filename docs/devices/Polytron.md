...
Total: **17** devices. Import: `import se.premex.compose.preview.device.catalog.android.Polytron`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| hayward | HAYWARD | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Polytron.HAYWARD)` |
| hirano | HIRANO | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Polytron.HIRANO)` |
