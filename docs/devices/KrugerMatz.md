...
Total: **42** devices. Import: `import se.premex.compose.preview.device.catalog.android.KrugerMatz`
...
| KM1077 | KM1077 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = KrugerMatz.KM1077)` |
| KM1077S | KM1077S | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = KrugerMatz.KM1077S)` |
| KM1078 | KM1078 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = KrugerMatz.KM1078)` |
| KM1078S | KM1078S | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = KrugerMatz.KM1078S)` |
