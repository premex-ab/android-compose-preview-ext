...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Onida`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| landen | LANDEN | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Onida.LANDEN)` |
