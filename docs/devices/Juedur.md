...
Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Juedur`
...
| R500_V_EEA | R500_V_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Juedur.R500_V_EEA)` |
| R500_V_US | R500_V_US | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Juedur.R500_V_US)` |
