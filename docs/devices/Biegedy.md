...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Biegedy`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| B21_EEA | B21_EEA | 600x1024 | 160 | `spec:width=600px,height=1024px,dpi=160` | `@Preview(device = Biegedy.B21_EEA)` |
| B22-U-EEA | B22_U_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Biegedy.B22_U_EEA)` |
...
| B25_EEA | B25_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Biegedy.B25_EEA)` |
