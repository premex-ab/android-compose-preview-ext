...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android._8849`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| OB-A98 | OB_A98 | 1440x3200 | 560 | `spec:width=1440px,height=3200px,dpi=560` | `@Preview(device = _8849.OB_A98)` |
| OB-A99 | OB_A99 | 1200x2652 | 480 | `spec:width=1200px,height=2652px,dpi=480` | `@Preview(device = _8849.OB_A99)` |
