...
Total: **35** devices. Import: `import se.premex.compose.preview.device.catalog.android.Vortex`
...
| JK68 | JK68 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Vortex.JK68)` |
...
| VORTEX_HD65_Choice | VORTEX_HD65_CHOICE | 1080x2248 | 480 | `spec:width=1080px,height=2248px,dpi=480` | `@Preview(device = Vortex.VORTEX_HD65_CHOICE)` |
