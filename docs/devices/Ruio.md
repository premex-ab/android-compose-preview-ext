...
Total: **14** devices. Import: `import se.premex.compose.preview.device.catalog.android.Ruio`
...
| RUIO_ZIP | RUIO_ZIP | 480x960 | 200 | `spec:width=480px,height=960px,dpi=200` | `@Preview(device = Ruio.RUIO_ZIP)` |
| S5506 | S5506 | 540x1132 | 240 | `spec:width=540px,height=1132px,dpi=240` | `@Preview(device = Ruio.S5506)` |
| S5521 | S5521 | 480x960 | 200 | `spec:width=480px,height=960px,dpi=200` | `@Preview(device = Ruio.S5521)` |
...
| S6537G | S6537G | 576x1280 | 240 | `spec:width=576px,height=1280px,dpi=240` | `@Preview(device = Ruio.S6537G)` |
| S6539Q | S6539Q | 540x1200 | 220 | `spec:width=540px,height=1200px,dpi=220` | `@Preview(device = Ruio.S6539Q)` |
