...
Total: **16** devices. Import: `import se.premex.compose.preview.device.catalog.android.Sunmi`
...
| FLEX3 | FLEX3 | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Sunmi.FLEX3)` |
| K2 | K2 | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Sunmi.K2)` |
| L3 | L3 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Sunmi.L3)` |
| OrderPAD_3 | ORDERPAD_3 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = Sunmi.ORDERPAD_3)` |
...
| T3 | T3 | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Sunmi.T3)` |
