...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Vale`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| V10A | V10A | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Vale.V10A)` |
...
| V10E_LTE_464 | V10E_LTE_464 | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Vale.V10E_LTE_464)` |
