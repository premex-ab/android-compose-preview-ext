...
Total: **25** devices. Import: `import se.premex.compose.preview.device.catalog.android.Kogan`
...
| alimos | ALIMOS | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Kogan.ALIMOS)` |
| cottongreen | COTTONGREEN | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Kogan.COTTONGREEN)` |
| dangni | DANGNI | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Kogan.DANGNI)` |
...
| sepolia | SEPOLIA | 2160x3840 | 320 | `spec:width=2160px,height=3840px,dpi=320` | `@Preview(device = Kogan.SEPOLIA)` |
