...
Total: **20** devices. Import: `import se.premex.compose.preview.device.catalog.android.Bluebird`
...
| EK430 | EK430 | 480x800 | 240 | `spec:width=480px,height=800px,dpi=240` | `@Preview(device = Bluebird.EK430)` |
...
| S10 | S10 | 720x1440 | 320 | `spec:width=720px,height=1440px,dpi=320` | `@Preview(device = Bluebird.S10)` |
