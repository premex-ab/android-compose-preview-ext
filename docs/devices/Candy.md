...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Candy`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| broadway | BROADWAY | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Candy.BROADWAY)` |
| deto | DETO | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Candy.DETO)` |
