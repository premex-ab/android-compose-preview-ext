...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Pixpeak`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| L60-EEA | L60_EEA | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Pixpeak.L60_EEA)` |
| M186-EEA | M186_EEA | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Pixpeak.M186_EEA)` |
