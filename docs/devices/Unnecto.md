...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Unnecto`
...
| Bolt_5G | BOLT_5G | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Unnecto.BOLT_5G)` |
