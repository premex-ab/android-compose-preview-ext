...
| TARGA-F11PRO | TARGA_F11PRO | 1200x1920 | 213 | `spec:width=1200px,height=1920px,dpi=213` | `@Preview(device = PackardBell.TARGA_F11PRO)` |
| TARGA-F8 | TARGA_F8 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = PackardBell.TARGA_F8)` |
