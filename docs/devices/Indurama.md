...
Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Indurama`
...
| jagalchi | JAGALCHI | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Indurama.JAGALCHI)` |
