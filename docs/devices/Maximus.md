...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Maximus`
...
| G10_max | G10_MAX | 600x1280 | 240 | `spec:width=600px,height=1280px,dpi=240` | `@Preview(device = Maximus.G10_MAX)` |
