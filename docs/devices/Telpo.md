...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Telpo`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| C9D | C9D | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Telpo.C9D)` |
