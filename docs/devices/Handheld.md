...
Total: **12** devices. Import: `import se.premex.compose.preview.device.catalog.android.Handheld`
...
| condor | CONDOR | 1080x2340 | 480 | `spec:width=1080px,height=2340px,dpi=480` | `@Preview(device = Handheld.CONDOR)` |
