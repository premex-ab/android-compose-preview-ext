...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.We`
...
| WE_R4 | WE_R4 | 1080x1920 | 480 | `spec:width=1080px,height=1920px,dpi=480` | `@Preview(device = We.WE_R4)` |
