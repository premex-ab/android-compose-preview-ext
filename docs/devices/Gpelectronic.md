# Gpelectronic Devices

Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Gpelectronic`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| YC-08P | YC_08P | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Gpelectronic.YC_08P)` |
