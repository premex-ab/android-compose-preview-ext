...
Total: **10** devices. Import: `import se.premex.compose.preview.device.catalog.android.Vikusha`
...
| V_M1 | V_M1 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Vikusha.V_M1)` |
