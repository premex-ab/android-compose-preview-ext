...
Total: **5** devices. Import: `import se.premex.compose.preview.device.catalog.android.Getac`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| zx10 | ZX10 | 1200x1920 | 260 | `spec:width=1200px,height=1920px,dpi=260` | `@Preview(device = Getac.ZX10)` |
| zx10g2 | ZX10G2 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = Getac.ZX10G2)` |
