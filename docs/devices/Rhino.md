...
Total: **9** devices. Import: `import se.premex.compose.preview.device.catalog.android.Rhino`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| atom | ATOM | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Rhino.ATOM)` |
...
| Rhino_C10 | RHINO_C10 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = Rhino.RHINO_C10)` |
