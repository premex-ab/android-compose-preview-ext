...
| G9_1 | G9_1 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = GTab.G9_1)` |
...
| PAD11 | PAD11 | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = GTab.PAD11)` |
...
| X | X | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = GTab.X)` |
