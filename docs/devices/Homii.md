...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Homii`
...
| XBOOK_8M | XBOOK_8M | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Homii.XBOOK_8M)` |
