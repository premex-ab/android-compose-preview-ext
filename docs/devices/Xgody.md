...
| N02_Pro | N02_PRO | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Xgody.N02_PRO)` |
...
| X36 | X36 | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Xgody.X36)` |
