...
Total: **46** devices. Import: `import se.premex.compose.preview.device.catalog.android.Nuu`
...
| N6504LA | N6504LA | 720x1600 | 280 | `spec:width=720px,height=1600px,dpi=280` | `@Preview(device = Nuu.N6504LA)` |
...
| S6008LA | S6008LA | 480x960 | 213 | `spec:width=480px,height=960px,dpi=213` | `@Preview(device = Nuu.S6008LA)` |
...
| S6710XA | S6710XA | 1080x2400 | 480 | `spec:width=1080px,height=2400px,dpi=480` | `@Preview(device = Nuu.S6710XA)` |
