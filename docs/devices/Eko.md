...
Total: **20** devices. Import: `import se.premex.compose.preview.device.catalog.android.Eko`
...
| dongmae | DONGMAE | 1080x1920 | 213 | `spec:width=1080px,height=1920px,dpi=213` | `@Preview(device = Eko.DONGMAE)` |
