...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Avidpad`
...
| A90PRO | A90PRO | 1200x2000 | 280 | `spec:width=1200px,height=2000px,dpi=280` | `@Preview(device = Avidpad.A90PRO)` |
| A90S-1 | A90S_1 | 1200x1920 | 240 | `spec:width=1200px,height=1920px,dpi=240` | `@Preview(device = Avidpad.A90S_1)` |
