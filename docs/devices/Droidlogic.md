...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Droidlogic`
...
| ohm | OHM | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Droidlogic.OHM)` |
