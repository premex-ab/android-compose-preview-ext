...
Total: **8** devices. Import: `import se.premex.compose.preview.device.catalog.android.Fastwd`
...
| M193-EEA | M193_EEA | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Fastwd.M193_EEA)` |
...
| M986-EEA | M986_EEA | 1200x2000 | 240 | `spec:width=1200px,height=2000px,dpi=240` | `@Preview(device = Fastwd.M986_EEA)` |
