...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Lincplus`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| M8_US | M8_US | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Lincplus.M8_US)` |
