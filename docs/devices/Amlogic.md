...
Total: **3** devices. Import: `import se.premex.compose.preview.device.catalog.android.Amlogic`
...
| p281 | P281 | 720x1280 | 160 | `spec:width=720px,height=1280px,dpi=160` | `@Preview(device = Amlogic.P281)` |
