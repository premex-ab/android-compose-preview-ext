...
Total: **24** devices. Import: `import se.premex.compose.preview.device.catalog.android.Konrow`
...
| K-TAB703 | K_TAB703 | 600x1024 | 155 | `spec:width=600px,height=1024px,dpi=155` | `@Preview(device = Konrow.K_TAB703)` |
...
| TOUCH55 | TOUCH55 | 480x960 | 200 | `spec:width=480px,height=960px,dpi=200` | `@Preview(device = Konrow.TOUCH55)` |
