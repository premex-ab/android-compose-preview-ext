...
Total: **3** devices. Import: `import se.premex.compose.preview.device.catalog.android.Xenon`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| dongnae | DONGNAE | 720x1280 | 213 | `spec:width=720px,height=1280px,dpi=213` | `@Preview(device = Xenon.DONGNAE)` |
