...
Total: **6** devices. Import: `import se.premex.compose.preview.device.catalog.android.Emerson`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| EID-1400 | EID_1400 | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Emerson.EID_1400)` |
| EID_1001 | EID_1001 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Emerson.EID_1001)` |
...
| EID_1062 | EID_1062 | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Emerson.EID_1062)` |
