...
Total: **4** devices. Import: `import se.premex.compose.preview.device.catalog.android.Telesystem`
...
| ROM | ROM | 1080x1920 | 320 | `spec:width=1080px,height=1920px,dpi=320` | `@Preview(device = Telesystem.ROM)` |
