...
Total: **22** devices. Import: `import se.premex.compose.preview.device.catalog.android.Lt`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| HLTE227E | HLTE227E | 720x1600 | 320 | `spec:width=720px,height=1600px,dpi=320` | `@Preview(device = Lt.HLTE227E)` |
| HS8909QC | HS8909QC | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Lt.HS8909QC)` |
| HS8917QC | HS8917QC | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Lt.HS8917QC)` |
| LT | LT | 720x1520 | 320 | `spec:width=720px,height=1520px,dpi=320` | `@Preview(device = Lt.LT)` |
...
| LT_8102 | LT_8102 | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Lt.LT_8102)` |
...
| LT_9904 | LT_9904 | 1080x2400 | 480 | `spec:width=1080px,height=2400px,dpi=480` | `@Preview(device = Lt.LT_9904)` |
