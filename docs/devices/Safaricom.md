...
Total: **12** devices. Import: `import se.premex.compose.preview.device.catalog.android.Safaricom`
...
| Neon_Ultra_2_M | NEON_ULTRA_2_M | 720x1600 | 300 | `spec:width=720px,height=1600px,dpi=300` | `@Preview(device = Safaricom.NEON_ULTRA_2_M)` |
