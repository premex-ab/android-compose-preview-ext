...
Total: **3** devices. Import: `import se.premex.compose.preview.device.catalog.android.Mediatek`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| m7332 | M7332 | 1080x1920 | 240 | `spec:width=1080px,height=1920px,dpi=240` | `@Preview(device = Mediatek.M7332)` |
