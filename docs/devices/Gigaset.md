...
Total: **33** devices. Import: `import se.premex.compose.preview.device.catalog.android.Gigaset`
...
| GP20 | GP20 | 720x1600 | 480 | `spec:width=720px,height=1600px,dpi=480` | `@Preview(device = Gigaset.GP20)` |
...
| GS6_Venus | GS6_VENUS | 1080x2400 | 480 | `spec:width=1080px,height=2400px,dpi=480` | `@Preview(device = Gigaset.GS6_VENUS)` |
