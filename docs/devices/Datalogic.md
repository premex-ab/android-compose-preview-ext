...
Total: **10** devices. Import: `import se.premex.compose.preview.device.catalog.android.Datalogic`

| Code | Constant | Resolution | DPI | Compose Spec | Preview Usage |
|------|----------|------------|-----|-------------|---------------|
| dl35 | DL35 | 720x1280 | 320 | `spec:width=720px,height=1280px,dpi=320` | `@Preview(device = Datalogic.DL35)` |
| jta11 | JTA11 | 480x854 | 240 | `spec:width=480px,height=854px,dpi=240` | `@Preview(device = Datalogic.JTA11)` |
...
| mk2 | MK2 | 480x800 | 240 | `spec:width=480px,height=800px,dpi=240` | `@Preview(device = Datalogic.MK2)` |
