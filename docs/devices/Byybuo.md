...
Total: **14** devices. Import: `import se.premex.compose.preview.device.catalog.android.Byybuo`
...
| A10_M_US | A10_M_US | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Byybuo.A10_M_US)` |
...
| E220_M_US | E220_M_US | 800x1280 | 160 | `spec:width=800px,height=1280px,dpi=160` | `@Preview(device = Byybuo.E220_M_US)` |
