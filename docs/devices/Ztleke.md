...
Total: **6** devices. Import: `import se.premex.compose.preview.device.catalog.android.Ztleke`
...
| P10Pro3 | P10PRO3 | 800x1280 | 200 | `spec:width=800px,height=1280px,dpi=200` | `@Preview(device = Ztleke.P10PRO3)` |
