...
Total: **7** devices. Import: `import se.premex.compose.preview.device.catalog.android.Odea`
...
| A13 | A13 | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Odea.A13)` |
