...
Total: **55** devices. Import: `import se.premex.compose.preview.device.catalog.android.Oscal`
...
| Pad_30_WiFi | PAD_30_WIFI | 800x1280 | 213 | `spec:width=800px,height=1280px,dpi=213` | `@Preview(device = Oscal.PAD_30_WIFI)` |
...
| Pad_90_Pro | PAD_90_PRO | 1200x1920 | 280 | `spec:width=1200px,height=1920px,dpi=280` | `@Preview(device = Oscal.PAD_90_PRO)` |
...
| PILOT_3 | PILOT_3 | 1080x2460 | 480 | `spec:width=1080px,height=2460px,dpi=480` | `@Preview(device = Oscal.PILOT_3)` |
...
| SPIDER_10 | SPIDER_10 | 1200x1920 | 260 | `spec:width=1200px,height=1920px,dpi=260` | `@Preview(device = Oscal.SPIDER_10)` |
| TANK_1 | TANK_1 | 1080x2460 | 480 | `spec:width=1080px,height=2460px,dpi=480` | `@Preview(device = Oscal.TANK_1)` |
...
| TIGER_8 | TIGER_8 | 720x1640 | 320 | `spec:width=720px,height=1640px,dpi=320` | `@Preview(device = Oscal.TIGER_8)` |
