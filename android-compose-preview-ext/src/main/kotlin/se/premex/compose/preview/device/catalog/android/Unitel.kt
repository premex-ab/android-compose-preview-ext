...
public object Unitel {
   ...
   */
  public const val UNITEL_TAB_4G_H101: String = "spec:width=800px,height=1280px,dpi=160"

  /**
   * Unitel USMART6
   */
  public const val USMART6: String = "spec:width=720px,height=1612px,dpi=320"
}
